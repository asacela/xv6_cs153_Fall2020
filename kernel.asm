...
801003a0:	e8 bb 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003a5:	c7 04 24 3b 7d 10 80 	movl   $0x80107d3b,(%esp)
...
801003b8:	e8 73 41 00 00       	call   80104530 <getcallerpcs>
...
80100785:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        s = "(null)";
80100788:	b8 b8 73 10 80       	mov    $0x801073b8,%eax
...
801007d8:	68 bf 73 10 80       	push   $0x801073bf
...
801009a6:	68 c8 73 10 80       	push   $0x801073c8
801009ab:	68 20 a5 10 80       	push   $0x8010a520
801009b0:	e8 5b 3b 00 00       	call   80104510 <initlock>
...
80100bc6:	68 e1 73 10 80       	push   $0x801073e1
...
80100c51:	e8 5a 66 00 00       	call   801072b0 <copyout>
...
80100cb5:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  ...
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100cbb:	e8 f0 65 00 00       	call   801072b0 <copyout>
...
80100d56:	68 ed 73 10 80       	push   $0x801073ed
80100d5b:	68 c0 ff 10 80       	push   $0x8010ffc0
80100d60:	e8 ab 37 00 00       	call   80104510 <initlock>
}
...
80100e1b:	68 f4 73 10 80       	push   $0x801073f4
...
80100ef2:	68 fc 73 10 80       	push   $0x801073fc
...
80100fd2:	68 06 74 10 80       	push   $0x80107406
...
801010e4:	68 0f 74 10 80       	push   $0x8010740f
...
801010f1:	68 15 74 10 80       	push   $0x80107415
...
80101165:	68 1f 74 10 80       	push   $0x8010741f
...
80101212:	68 32 74 10 80       	push   $0x80107432
...
80101255:	e8 16 35 00 00       	call   80104770 <memset>
  log_write(bp);
...
8010129a:	e8 d1 33 00 00       	call   80104670 <acquire>
...
801012df:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801012e2:	e8 39 34 00 00       	call   80104720 <release>
      return ip;
...
8010132f:	e8 ec 33 00 00       	call   80104720 <release>
...
80101344:	68 48 74 10 80       	push   $0x80107448
...
8010140a:	68 58 74 10 80       	push   $0x80107458
...
80101441:	e8 da 33 00 00       	call   80104820 <memmove>
  brelse(bp);
...
8010146c:	68 6b 74 10 80       	push   $0x8010746b
80101471:	68 e0 09 11 80       	push   $0x801109e0
80101476:	e8 95 30 00 00       	call   80104510 <initlock>
8010147b:	83 c4 10             	add    $0x10,%esp
8010147e:	66 90                	xchg   %ax,%ax
  for(i = 0; i < NINODE; i++) {
    initsleeplock(&icache.inode[i].lock, "inode");
80101480:	83 ec 08             	sub    $0x8,%esp
80101483:	68 72 74 10 80       	push   $0x80107472
80101488:	53                   	push   %ebx
80101489:	81 c3 90 00 00 00    	add    $0x90,%ebx
8010148f:	e8 4c 2f 00 00       	call   801043e0 <initsleeplock>
iinit(int dev)
{
  int i = 0;
...
801014d9:	68 d8 74 10 80       	push   $0x801074d8
...
801015a3:	68 78 74 10 80       	push   $0x80107478
...
8010163f:	e8 2c 30 00 00       	call   80104670 <acquire>
  ip->ref++;
...
80101682:	e8 99 2d 00 00       	call   80104420 <acquiresleep>
...
8010171d:	68 90 74 10 80       	push   $0x80107490
...
8010172a:	68 8a 74 10 80       	push   $0x8010748a
...
80101753:	e8 68 2d 00 00       	call   801044c0 <holdingsleep>
...
iunlock(struct inode *ip)
{
  ...
  releasesleep(&ip->lock);
8010176f:	e9 0c 2d 00 00       	jmp    80104480 <releasesleep>
// Unlock the given inode.
void
iunlock(struct inode *ip)
{
...
80101777:	68 9f 74 10 80       	push   $0x8010749f
...
801017a0:	e8 7b 2c 00 00       	call   80104420 <acquiresleep>
...
801017ba:	e8 c1 2c 00 00       	call   80104480 <releasesleep>

  acquire(&icache.lock);
801017bf:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801017c6:	e8 a5 2e 00 00       	call   80104670 <acquire>
  ip->ref--;
...
801017df:	5d                   	pop    %ebp
  ...
  ip->ref--;
  release(&icache.lock);
801017e0:	e9 3b 2f 00 00       	jmp    80104720 <release>
...
801017f0:	e8 7b 2e 00 00       	call   80104670 <acquire>
    int r = ip->ref;
801017f5:	8b 5e 08             	mov    0x8(%esi),%ebx
    release(&icache.lock);
801017f8:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801017ff:	e8 1c 2f 00 00       	call   80104720 <release>
    if(r == 1){
...
80101ae4:	e8 37 2d 00 00       	call   80104820 <memmove>
    log_write(bp);
...
80101be5:	e8 b6 2c 00 00       	call   801048a0 <strncmp>
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlookup read");
    if(de.inum == 0)
...
80101c1d:	68 b9 74 10 80       	push   $0x801074b9
...
80101c2a:	68 a7 74 10 80       	push   $0x801074a7
...
80101c69:	e8 02 2a 00 00       	call   80104670 <acquire>
  ip->ref++;
80101c6e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101c72:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101c79:	e8 a2 2a 00 00       	call   80104720 <release>
...
80101d64:	e8 b7 2a 00 00       	call   80104820 <memmove>
    name[len] = 0;
...
80101e4d:	e8 be 2a 00 00       	call   80104910 <strncpy>
  de.inum = inum;
...
80101e8b:	68 c8 74 10 80       	push   $0x801074c8
...
80101e98:	68 22 7b 10 80       	push   $0x80107b22
...
80101fa0:	68 34 75 10 80       	push   $0x80107534
...
80101fad:	68 2b 75 10 80       	push   $0x8010752b
...
80101fc6:	68 46 75 10 80       	push   $0x80107546
80101fcb:	68 80 a5 10 80       	push   $0x8010a580
80101fd0:	e8 3b 25 00 00       	call   80104510 <initlock>
...
8010204e:	e8 1d 26 00 00       	call   80104670 <acquire>
...
8010207e:	e8 2d 21 00 00       	call   801041b0 <wakeup>
...
8010209c:	e8 7f 26 00 00       	call   80104720 <release>
  // Start disk on next buf in queue.
  if(idequeue != 0)
    idestart(idequeue);
...
801020ee:	e8 cd 23 00 00       	call   801044c0 <holdingsleep>
...
80102128:	e8 43 25 00 00       	call   80104670 <acquire>
...
80102195:	c9                   	leave  
  ...
  release(&idelock);
80102196:	e9 85 25 00 00       	jmp    80104720 <release>
...
801021ae:	68 4a 75 10 80       	push   $0x8010754a
...
801021bb:	68 75 75 10 80       	push   $0x80107575
...
801021c8:	68 60 75 10 80       	push   $0x80107560
...
8010222a:	68 94 75 10 80       	push   $0x80107594
...
801022e2:	81 fb a8 6e 11 80    	cmp    $0x80116ea8,%ebx
...
80102348:	e8 23 23 00 00       	call   80104670 <acquire>
...
80102355:	68 c6 75 10 80       	push   $0x801075c6
...
801023bb:	68 cc 75 10 80       	push   $0x801075cc
801023c0:	68 40 26 11 80       	push   $0x80112640
801023c5:	e8 46 21 00 00       	call   80104510 <initlock>
...
801024c8:	e8 a3 21 00 00       	call   80104670 <acquire>
  r = kmem.freelist;
...
80102526:	0f b6 82 00 77 10 80 	movzbl -0x7fef8900(%edx),%eax
...
8010254e:	0f b6 82 00 77 10 80 	movzbl -0x7fef8900(%edx),%eax
80102555:	09 c1                	or     %eax,%ecx
80102557:	0f b6 82 00 76 10 80 	movzbl -0x7fef8a00(%edx),%eax
...
8010256b:	83 e1 08             	and    $0x8,%ecx
  ...
  shift ^= togglecode[data];
  c = charcode[shift & (CTL | SHIFT)][data];
8010256e:	8b 04 85 e0 75 10 80 	mov    -0x7fef8a20(,%eax,4),%eax
...
801028d4:	e8 e7 1e 00 00       	call   801047c0 <memcmp>
...
80102a04:	e8 17 1e 00 00       	call   80104820 <memmove>
...
80102aaa:	68 00 78 10 80       	push   $0x80107800
80102aaf:	68 80 26 11 80       	push   $0x80112680
80102ab4:	e8 57 1a 00 00       	call   80104510 <initlock>
  readsb(dev, &sb);
80102ab9:	58                   	pop    %eax
...
80102b4b:	e8 20 1b 00 00       	call   80104670 <acquire>
...
80102b65:	e8 16 13 00 00       	call   80103e80 <sleep>
...
80102b9c:	e8 7f 1b 00 00       	call   80104720 <release>
      break;
    }
  }
}
...
80102bbe:	e8 ad 1a 00 00       	call   80104670 <acquire>
  log.outstanding -= 1;
...
80102bfd:	e8 1e 1b 00 00       	call   80104720 <release>
}
...
80102c5c:	e8 bf 1b 00 00       	call   80104820 <memmove>
...
80102ca5:	e8 c6 19 00 00       	call   80104670 <acquire>
    log.committing = 0;
    wakeup(&log);
...
80102cb8:	00 00 00 
    wakeup(&log);
80102cbb:	e8 f0 14 00 00       	call   801041b0 <wakeup>
    release(&log.lock);
80102cc0:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102cc7:	e8 54 1a 00 00       	call   80104720 <release>
...
80102ce8:	e8 c3 14 00 00       	call   801041b0 <wakeup>
  }
  release(&log.lock);
80102ced:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102cf4:	e8 27 1a 00 00       	call   80104720 <release>
...
80102d07:	68 04 78 10 80       	push   $0x80107804
...
80102d5e:	e8 0d 19 00 00       	call   80104670 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102dad:	c9                   	leave  
  ...
  b->flags |= B_DIRTY; // prevent eviction
  release(&log.lock);
80102dae:	e9 6d 19 00 00       	jmp    80104720 <release>
80102db3:	90                   	nop
...
80102dd3:	68 13 78 10 80       	push   $0x80107813
80102dd8:	e8 93 d5 ff ff       	call   80100370 <panic>
  if (log.outstanding < 1)
    panic("log_write outside of trans");
80102ddd:	83 ec 0c             	sub    $0xc,%esp
80102de0:	68 29 78 10 80       	push   $0x80107829
...
80102e08:	68 44 78 10 80       	push   $0x80107844
80102e0d:	e8 4e d8 ff ff       	call   80100660 <cprintf>
  idtinit();       // load idt register
80102e12:	e8 29 2d 00 00       	call   80105b40 <idtinit>
...
80102e33:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e36:	e8 45 3e 00 00       	call   80106c80 <switchkvm>
  seginit();
80102e3b:	e8 40 3d 00 00       	call   80106b80 <seginit>
  lapicinit();
...
80102e99:	e8 b2 2f 00 00       	call   80105e50 <uartinit>
  pinit();         // process table
80102e9e:	e8 1d 08 00 00       	call   801036c0 <pinit>
  tvinit();        // trap vectors
80102ea3:	e8 f8 2b 00 00       	call   80105aa0 <tvinit>
  binit();         // buffer cache
...
80102ec9:	e8 52 19 00 00       	call   80104820 <memmove>
...
80102f98:	68 58 78 10 80       	push   $0x80107858
80102f9d:	56                   	push   %esi
80102f9e:	e8 1d 18 00 00       	call   801047c0 <memcmp>
...
8010305c:	68 5d 78 10 80       	push   $0x8010785d
80103061:	56                   	push   %esi
80103062:	e8 59 17 00 00       	call   801047c0 <memcmp>
...
801030f0:	ff 24 95 9c 78 10 80 	jmp    *-0x7fef8764(,%edx,4)
...
80103197:	68 62 78 10 80       	push   $0x80107862
...
801031a4:	68 7c 78 10 80       	push   $0x8010787c
...
80103250:	00 00 00 
  initlock(&p->lock, "pipe");
80103253:	68 b0 78 10 80       	push   $0x801078b0
80103258:	50                   	push   %eax
80103259:	e8 b2 12 00 00       	call   80104510 <initlock>
  (*f0)->type = FD_PIPE;
...
801032ef:	e8 7c 13 00 00       	call   80104670 <acquire>
  if(writable){
...
8010330f:	e8 9c 0e 00 00       	call   801041b0 <wakeup>
...
80103333:	5d                   	pop    %ebp
  ...
  if(p->readopen == 0 && p->writeopen == 0){
    ...
    release(&p->lock);
80103334:	e9 e7 13 00 00       	jmp    80104720 <release>
...
80103354:	e8 57 0e 00 00       	call   801041b0 <wakeup>
...
80103364:	e8 b7 13 00 00       	call   80104720 <release>
    kfree((char*)p);
...
8010338d:	e8 de 12 00 00       	call   80104670 <acquire>
  for(i = 0; i < n; i++){
...
801033e0:	e8 cb 0d 00 00       	call   801041b0 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
801033e5:	58                   	pop    %eax
801033e6:	5a                   	pop    %edx
801033e7:	53                   	push   %ebx
801033e8:	56                   	push   %esi
801033e9:	e8 92 0a 00 00       	call   80103e80 <sleep>
{
  int i;
...
80103414:	e8 07 13 00 00       	call   80104720 <release>
        return -1;
...
80103463:	e8 48 0d 00 00       	call   801041b0 <wakeup>
  release(&p->lock);
80103468:	89 1c 24             	mov    %ebx,(%esp)
8010346b:	e8 b0 12 00 00       	call   80104720 <release>
  return n;
...
80103490:	e8 db 11 00 00       	call   80104670 <acquire>
...
801034c5:	e8 b6 09 00 00       	call   80103e80 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
801034f9:	e8 22 12 00 00       	call   80104720 <release>
      return -1;
...
8010355e:	e8 4d 0c 00 00       	call   801041b0 <wakeup>
  release(&p->lock);
80103563:	89 1c 24             	mov    %ebx,(%esp)
80103566:	e8 b5 11 00 00       	call   80104720 <release>
  return i;
...
801035b1:	e8 ba 10 00 00       	call   80104670 <acquire>
801035b6:	83 c4 10             	add    $0x10,%esp
801035b9:	eb 13                	jmp    801035ce <allocproc+0x2e>
801035bb:	90                   	nop
801035bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801035c0:	81 c3 e4 00 00 00    	add    $0xe4,%ebx
801035c6:	81 fb 54 66 11 80    	cmp    $0x80116654,%ebx
801035cc:	74 7a                	je     80103648 <allocproc+0xa8>
    if (p->state == UNUSED)
801035ce:	8b 43 0c             	mov    0xc(%ebx),%eax
801035d1:	85 c0                	test   %eax,%eax
801035d3:	75 eb                	jne    801035c0 <allocproc+0x20>
  release(&ptable.lock);
  return 0;
...
found:
  p->state = EMBRYO;
  p->pid = nextpid++;
801035d5:	a1 04 a0 10 80       	mov    0x8010a004,%eax
...
found:
  p->state = EMBRYO;
801035dd:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->pid = nextpid++;
...
found:
  p->state = EMBRYO;
  p->pid = nextpid++;
801035e9:	8d 50 01             	lea    0x1(%eax),%edx
801035ec:	89 43 10             	mov    %eax,0x10(%ebx)
801035ef:	89 15 04 a0 10 80    	mov    %edx,0x8010a004

  release(&ptable.lock);
801035f5:	e8 26 11 00 00       	call   80104720 <release>

  // Allocate kernel stack.
  if ((p->kstack = kalloc()) == 0)
801035fa:	e8 81 ee ff ff       	call   80102480 <kalloc>
801035ff:	83 c4 10             	add    $0x10,%esp
80103602:	85 c0                	test   %eax,%eax
80103604:	89 43 08             	mov    %eax,0x8(%ebx)
80103607:	74 56                	je     8010365f <allocproc+0xbf>
    return 0;
  }
  ...
  sp -= sizeof *p->tf;
80103609:	8d 90 b4 0f 00 00    	lea    0xfb4(%eax),%edx
  sp -= 4;
...
8010360f:	83 ec 04             	sub    $0x4,%esp
  ...
  *(uint *)sp = (uint)trapret;
  ...
  sp -= sizeof *p->context;
80103612:	05 9c 0f 00 00       	add    $0xf9c,%eax
    return 0;
  }
  sp = p->kstack + KSTACKSIZE;
  ...
  // Leave room for trap frame.
  sp -= sizeof *p->tf;
80103617:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint *)sp = (uint)trapret;
8010361a:	c7 40 14 8f 5a 10 80 	movl   $0x80105a8f,0x14(%eax)

  sp -= sizeof *p->context;
  p->context = (struct context *)sp;
  memset(p->context, 0, sizeof *p->context);
80103621:	6a 14                	push   $0x14
80103623:	6a 00                	push   $0x0
80103625:	50                   	push   %eax
  // which returns to trapret.
  sp -= 4;
  *(uint *)sp = (uint)trapret;
  ...
  sp -= sizeof *p->context;
  p->context = (struct context *)sp;
80103626:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103629:	e8 42 11 00 00       	call   80104770 <memset>
  p->context->eip = (uint)forkret;
8010362e:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80103631:	83 c4 10             	add    $0x10,%esp
  *(uint *)sp = (uint)trapret;
  ...
  memset(p->context, 0, sizeof *p->context);
  p->context->eip = (uint)forkret;
80103634:	c7 40 10 70 36 10 80 	movl   $0x80103670,0x10(%eax)

  return p;
8010363b:	89 d8                	mov    %ebx,%eax
}
8010363d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103640:	c9                   	leave  
80103641:	c3                   	ret    
...
8010364b:	68 20 2d 11 80       	push   $0x80112d20
80103650:	e8 cb 10 00 00       	call   80104720 <release>
  return 0;
80103655:	83 c4 10             	add    $0x10,%esp
80103658:	31 c0                	xor    %eax,%eax
  p->context = (struct context *)sp;
  memset(p->context, 0, sizeof *p->context);
  p->context->eip = (uint)forkret;
...
8010365e:	c3                   	ret    
  ...
  {
    p->state = UNUSED;
8010365f:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return 0;
80103666:	eb d5                	jmp    8010363d <allocproc+0x9d>
80103668:	90                   	nop
...
801036c6:	68 b5 78 10 80       	push   $0x801078b5
801036cb:	68 20 2d 11 80       	push   $0x80112d20
801036d0:	e8 3b 0e 00 00       	call   80104510 <initlock>
}
...
8010373d:	68 bc 78 10 80       	push   $0x801078bc
...
8010374a:	68 04 7a 10 80       	push   $0x80107a04
...
80103784:	83 ec 04             	sub    $0x4,%esp
  ...
  struct proc *p;
  pushcli();
80103787:	e8 04 0e 00 00       	call   80104590 <pushcli>
  c = mycpu();
...
801037c3:	e8 d8 38 00 00       	call   801070a0 <setupkvm>
...
801037e1:	e8 ca 35 00 00       	call   80106db0 <inituvm>
  p->sz = PGSIZE;
...
801037f6:	e8 75 0f 00 00       	call   80104770 <memset>
...
8010384f:	68 e5 78 10 80       	push   $0x801078e5
80103854:	50                   	push   %eax
80103855:	e8 16 11 00 00       	call   80104970 <safestrcpy>
  p->cwd = namei("/");
8010385a:	c7 04 24 ee 78 10 80 	movl   $0x801078ee,(%esp)
...
80103870:	e8 fb 0d 00 00       	call   80104670 <acquire>
...
80103883:	e8 98 0e 00 00       	call   80104720 <release>
}
...
80103893:	68 cc 78 10 80       	push   $0x801078cc
...
myproc(void)
{
  ...
  struct proc *p;
  pushcli();
801038a8:	e8 e3 0c 00 00       	call   80104590 <pushcli>
  c = mycpu();
...
801038ce:	e8 1d 36 00 00       	call   80106ef0 <allocuvm>
...
801038e0:	e8 bb 33 00 00       	call   80106ca0 <switchuvm>
  return 0;
...
80103904:	e8 e7 36 00 00       	call   80106ff0 <deallocuvm>
...
myproc(void)
{
  ...
  struct proc *p;
  pushcli();
80103929:	e8 62 0c 00 00       	call   80104590 <pushcli>
  c = mycpu();
...
80103958:	e8 13 38 00 00       	call   80107170 <copyuvm>
...
801039d1:	e8 9a 0f 00 00       	call   80104970 <safestrcpy>
...
801039e0:	e8 8b 0c 00 00       	call   80104670 <acquire>
...
801039f3:	e8 28 0d 00 00       	call   80104720 <release>
...
myproc(void)
{
  ...
  struct proc *p;
  pushcli();
80103a49:	e8 42 0b 00 00       	call   80104590 <pushcli>
  c = mycpu();
80103a4e:	e8 8d fc ff ff       	call   801036e0 <mycpu>
  p = c->proc;
80103a53:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
...
void scheduler(void)
{
  ...
  struct proc *p;
  struct cpu *c = mycpu();
80103a5e:	e8 7d fc ff ff       	call   801036e0 <mycpu>
  c->proc = 0;
...
80103a70:	83 c0 04             	add    $0x4,%eax
80103a73:	89 45 dc             	mov    %eax,-0x24(%ebp)
...
80103a89:	e8 e2 0b 00 00       	call   80104670 <acquire>
80103a8e:	83 c4 10             	add    $0x10,%esp
  {
    ...
    // Loop over process table looking for process to run.
    int range = 31; // 0-31 range would be 32 i think -> changed to 31
80103a91:	b9 1f 00 00 00       	mov    $0x1f,%ecx

    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a96:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103a9b:	eb 0f                	jmp    80103aac <scheduler+0x6c>
80103a9d:	8d 76 00             	lea    0x0(%esi),%esi
80103aa0:	05 e4 00 00 00       	add    $0xe4,%eax
80103aa5:	3d 54 66 11 80       	cmp    $0x80116654,%eax
80103aaa:	74 1d                	je     80103ac9 <scheduler+0x89>

        if(p->state != RUNNABLE) {
80103aac:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103ab0:	75 ee                	jne    80103aa0 <scheduler+0x60>

            continue;
        }

        else if(p->priority < range) {
80103ab2:	8b b8 d4 00 00 00    	mov    0xd4(%eax),%edi
80103ab8:	39 f9                	cmp    %edi,%ecx
80103aba:	0f 4f cf             	cmovg  %edi,%ecx
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103abd:	05 e4 00 00 00       	add    $0xe4,%eax
80103ac2:	3d 54 66 11 80       	cmp    $0x80116654,%eax
80103ac7:	75 e3                	jne    80103aac <scheduler+0x6c>
80103ac9:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103ace:	eb 14                	jmp    80103ae4 <scheduler+0xa4>
...
80103ad2:	0f 84 e0 00 00 00    	je     80103bb8 <scheduler+0x178>
            range = p->priority;
        }
    }
    ...
    // AGING
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ad8:	05 e4 00 00 00       	add    $0xe4,%eax
80103add:	3d 54 66 11 80       	cmp    $0x80116654,%eax
80103ae2:	74 34                	je     80103b18 <scheduler+0xd8>
    {

        if (p->state == RUNNABLE && p != oldproc) 
80103ae4:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103ae8:	75 e6                	jne    80103ad0 <scheduler+0x90>
80103aea:	39 c6                	cmp    %eax,%esi
80103aec:	0f 84 c6 00 00 00    	je     80103bb8 <scheduler+0x178>
        {
            if(p->priority < 32 && p->priority > 0)
80103af2:	8b 90 d4 00 00 00    	mov    0xd4(%eax),%edx
80103af8:	8d 7a ff             	lea    -0x1(%edx),%edi
80103afb:	83 ff 1e             	cmp    $0x1e,%edi
80103afe:	77 d8                	ja     80103ad8 <scheduler+0x98>
            {
                p->priority -= 1;
80103b00:	89 b8 d4 00 00 00    	mov    %edi,0xd4(%eax)
            range = p->priority;
        }
    }
    ...
    // AGING
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103b06:	05 e4 00 00 00       	add    $0xe4,%eax
80103b0b:	3d 54 66 11 80       	cmp    $0x80116654,%eax
80103b10:	75 d2                	jne    80103ae4 <scheduler+0xa4>
80103b12:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80103b18:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103b1d:	eb 0f                	jmp    80103b2e <scheduler+0xee>
80103b1f:	90                   	nop
    }
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b20:	81 c3 e4 00 00 00    	add    $0xe4,%ebx
80103b26:	81 fb 54 66 11 80    	cmp    $0x80116654,%ebx
80103b2c:	74 72                	je     80103ba0 <scheduler+0x160>
        if (p->state != RUNNABLE)
80103b2e:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
80103b32:	75 ec                	jne    80103b20 <scheduler+0xe0>
            continue;

        if (p->priority == range) {
80103b34:	3b 8b d4 00 00 00    	cmp    0xd4(%ebx),%ecx
80103b3a:	75 e4                	jne    80103b20 <scheduler+0xe0>
            c->proc = p;
80103b3c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
            switchuvm(p);
80103b3f:	83 ec 0c             	sub    $0xc,%esp
80103b42:	89 4d e0             	mov    %ecx,-0x20(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
        if (p->state != RUNNABLE)
            continue;
        ...
        if (p->priority == range) {
            c->proc = p;
80103b45:	89 98 ac 00 00 00    	mov    %ebx,0xac(%eax)
            switchuvm(p);
80103b4b:	53                   	push   %ebx
80103b4c:	e8 4f 31 00 00       	call   80106ca0 <switchuvm>
            p->state = RUNNING;
80103b51:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)

            int before = ticks;
80103b58:	8b 3d a0 6e 11 80    	mov    0x80116ea0,%edi

            swtch(&(c->scheduler), p->context);
80103b5e:	58                   	pop    %eax
80103b5f:	5a                   	pop    %edx
80103b60:	ff 73 1c             	pushl  0x1c(%ebx)
80103b63:	ff 75 dc             	pushl  -0x24(%ebp)
80103b66:	e8 60 0e 00 00       	call   801049cb <swtch>
            switchkvm();
80103b6b:	e8 10 31 00 00       	call   80106c80 <switchkvm>

            p->runtime += ticks - before;
80103b70:	8b 15 a0 6e 11 80    	mov    0x80116ea0,%edx
            //cprintf("Burst time: %d seconds \n", sec);

            // Process is done running for now.
            // It should have changed its p->state before coming back.
            c->proc = 0;
80103b76:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80103b79:	83 c4 10             	add    $0x10,%esp
80103b7c:	8b 4d e0             	mov    -0x20(%ebp),%ecx
            int before = ticks;
            ...
            p->runtime += ticks - before;
80103b7f:	29 fa                	sub    %edi,%edx
80103b81:	01 93 e0 00 00 00    	add    %edx,0xe0(%ebx)
    }
    ...
    // before jumping back to us.
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b87:	81 c3 e4 00 00 00    	add    $0xe4,%ebx
80103b8d:	81 fb 54 66 11 80    	cmp    $0x80116654,%ebx
            p->runtime += ticks - before;
            //cprintf("Burst time: %d seconds \n", sec);
...
80103b9a:	00 00 00 
    ...
    // before jumping back to us.
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b9d:	75 8f                	jne    80103b2e <scheduler+0xee>
80103b9f:	90                   	nop
            c->proc = 0;
        }
...
80103ba8:	e8 73 0b 00 00       	call   80104720 <release>
  }
80103bad:	83 c4 10             	add    $0x10,%esp
80103bb0:	e9 cb fe ff ff       	jmp    80103a80 <scheduler+0x40>
80103bb5:	8d 76 00             	lea    0x0(%esi),%esi
        ...
        {
            if(p->priority == 0)
80103bb8:	8b 98 d4 00 00 00    	mov    0xd4(%eax),%ebx
80103bbe:	85 db                	test   %ebx,%ebx
80103bc0:	0f 85 12 ff ff ff    	jne    80103ad8 <scheduler+0x98>
            {
                p->priority += 1;
80103bc6:	c7 80 d4 00 00 00 01 	movl   $0x1,0xd4(%eax)
80103bcd:	00 00 00 
80103bd0:	e9 03 ff ff ff       	jmp    80103ad8 <scheduler+0x98>
...
myproc(void)
{
  ...
  struct proc *p;
  pushcli();
80103be5:	e8 a6 09 00 00       	call   80104590 <pushcli>
  c = mycpu();
80103bea:	e8 f1 fa ff ff       	call   801036e0 <mycpu>
  p = c->proc;
80103bef:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103bf5:	e8 d6 09 00 00       	call   801045d0 <popcli>
void sched(void)
{
  int intena;
...
80103c27:	75 41                	jne    80103c6a <sched+0x8a>
  ...
  intena = mycpu()->intena;
80103c29:	e8 b2 fa ff ff       	call   801036e0 <mycpu>
...
80103c31:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103c37:	e8 a4 fa ff ff       	call   801036e0 <mycpu>
80103c3c:	83 ec 08             	sub    $0x8,%esp
80103c3f:	ff 70 04             	pushl  0x4(%eax)
80103c42:	53                   	push   %ebx
80103c43:	e8 83 0d 00 00       	call   801049cb <swtch>
  mycpu()->intena = intena;
80103c48:	e8 93 fa ff ff       	call   801036e0 <mycpu>
}
...
80103c60:	68 f0 78 10 80       	push   $0x801078f0
...
80103c6d:	68 1c 79 10 80       	push   $0x8010791c
...
80103c7a:	68 0e 79 10 80       	push   $0x8010790e
...
80103c87:	68 02 79 10 80       	push   $0x80107902
...
myproc(void)
{
  ...
  struct proc *p;
  pushcli();
80103ca9:	e8 e2 08 00 00       	call   80104590 <pushcli>
  c = mycpu();
80103cae:	e8 2d fa ff ff       	call   801036e0 <mycpu>
  p = c->proc;
80103cb3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103cb9:	e8 12 09 00 00       	call   801045d0 <popcli>
{
  struct proc *curproc = myproc();
  struct proc *p;
  int fd;
...
80103cca:	0f 84 4c 01 00 00    	je     80103e1c <exit+0x17c>
      panic("init exiting");

  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
      if(curproc->ofile[fd]){
80103cd0:	8b 13                	mov    (%ebx),%edx
80103cd2:	85 d2                	test   %edx,%edx
80103cd4:	74 12                	je     80103ce8 <exit+0x48>
          fileclose(curproc->ofile[fd]);
80103cd6:	83 ec 0c             	sub    $0xc,%esp
80103cd9:	52                   	push   %edx
...
80103ced:	75 e1                	jne    80103cd0 <exit+0x30>
  ...
  begin_op();
80103cef:	e8 4c ee ff ff       	call   80102b40 <begin_op>
  iput(curproc->cwd);
80103cf4:	83 ec 0c             	sub    $0xc,%esp
80103cf7:	ff 76 68             	pushl  0x68(%esi)
80103cfa:	e8 91 da ff ff       	call   80101790 <iput>
  end_op();
80103cff:	e8 ac ee ff ff       	call   80102bb0 <end_op>
  curproc->cwd = 0;
80103d04:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)

  acquire(&ptable.lock);
80103d0b:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103d12:	e8 59 09 00 00       	call   80104670 <acquire>
...
80103d28:	05 e4 00 00 00       	add    $0xe4,%eax
80103d2d:	3d 54 66 11 80       	cmp    $0x80116654,%eax
...
wakeup1(void *chan)
{
  ...
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d46:	05 e4 00 00 00       	add    $0xe4,%eax
80103d4b:	3d 54 66 11 80       	cmp    $0x80116654,%eax
...
80103d5f:	90                   	nop
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d60:	81 c2 e4 00 00 00    	add    $0xe4,%edx
80103d66:	81 fa 54 66 11 80    	cmp    $0x80116654,%edx
...
wakeup1(void *chan)
{
  ...
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d88:	05 e4 00 00 00       	add    $0xe4,%eax
80103d8d:	3d 54 66 11 80       	cmp    $0x80116654,%eax
...
80103dab:	83 ec 08             	sub    $0x8,%esp
  ...
  // Adding exit status to PCB for given process
  curproc->status = status;
80103dae:	89 46 7c             	mov    %eax,0x7c(%esi)
  cprintf("Exit Status: [%d]\n", status);
80103db1:	50                   	push   %eax
80103db2:	68 3d 79 10 80       	push   $0x8010793d
80103db7:	e8 a4 c8 ff ff       	call   80100660 <cprintf>

  // Jump into the scheduler, never to return.
  cprintf("%d Turnaround time ticks\n", (ticks - curproc->tick));
80103dbc:	58                   	pop    %eax
80103dbd:	a1 a0 6e 11 80       	mov    0x80116ea0,%eax
80103dc2:	2b 86 dc 00 00 00    	sub    0xdc(%esi),%eax
80103dc8:	5a                   	pop    %edx
80103dc9:	50                   	push   %eax
80103dca:	68 50 79 10 80       	push   $0x80107950
80103dcf:	e8 8c c8 ff ff       	call   80100660 <cprintf>
  cprintf("%d Burst time ticks\n", curproc->runtime);
80103dd4:	59                   	pop    %ecx
80103dd5:	5b                   	pop    %ebx
80103dd6:	ff b6 e0 00 00 00    	pushl  0xe0(%esi)
80103ddc:	68 6a 79 10 80       	push   $0x8010796a
80103de1:	e8 7a c8 ff ff       	call   80100660 <cprintf>
  cprintf("%d Waiting time ticks\n",((ticks - curproc->tick) - (curproc->runtime)));
80103de6:	5f                   	pop    %edi
80103de7:	58                   	pop    %eax
80103de8:	a1 a0 6e 11 80       	mov    0x80116ea0,%eax
80103ded:	2b 86 dc 00 00 00    	sub    0xdc(%esi),%eax
80103df3:	2b 86 e0 00 00 00    	sub    0xe0(%esi),%eax
80103df9:	50                   	push   %eax
80103dfa:	68 7f 79 10 80       	push   $0x8010797f
80103dff:	e8 5c c8 ff ff       	call   80100660 <cprintf>
  
  //cprintf("%d Exit Burst time ticks\n", (ticks - curproc->tick));
  //curproc->status = status;
  curproc->state = ZOMBIE;
80103e04:	c7 46 0c 05 00 00 00 	movl   $0x5,0xc(%esi)
  sched();
80103e0b:	e8 d0 fd ff ff       	call   80103be0 <sched>
  panic("zombie exit");
80103e10:	c7 04 24 96 79 10 80 	movl   $0x80107996,(%esp)
...
80103e1f:	68 30 79 10 80       	push   $0x80107930
...
80103e3c:	e8 2f 08 00 00       	call   80104670 <acquire>
struct proc *
myproc(void)
{
  struct cpu *c;
  struct proc *p;
  pushcli();
80103e41:	e8 4a 07 00 00       	call   80104590 <pushcli>
  c = mycpu();
80103e46:	e8 95 f8 ff ff       	call   801036e0 <mycpu>
  p = c->proc;
...
80103e56:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
80103e5d:	e8 7e fd ff ff       	call   80103be0 <sched>
  release(&ptable.lock);
80103e62:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103e69:	e8 b2 08 00 00       	call   80104720 <release>
}
...
myproc(void)
{
  ...
  struct proc *p;
  pushcli();
80103e8f:	e8 fc 06 00 00       	call   80104590 <pushcli>
  c = mycpu();
80103e94:	e8 47 f8 ff ff       	call   801036e0 <mycpu>
  p = c->proc;
...
80103ec0:	e8 ab 07 00 00       	call   80104670 <acquire>
    release(lk);
80103ec5:	89 34 24             	mov    %esi,(%esp)
80103ec8:	e8 53 08 00 00       	call   80104720 <release>
  }
  // Go to sleep.
  p->chan = chan;
...
80103eea:	e8 31 08 00 00       	call   80104720 <release>
    acquire(lk);
...
80103efb:	5d                   	pop    %ebp
  ...
  { //DOC: sleeplock2
    release(&ptable.lock);
    acquire(lk);
80103efc:	e9 6f 07 00 00       	jmp    80104670 <acquire>
...
80103f29:	68 a8 79 10 80       	push   $0x801079a8
...
80103f36:	68 a2 79 10 80       	push   $0x801079a2
...
myproc(void)
{
  ...
  struct proc *p;
  pushcli();
80103f4c:	e8 3f 06 00 00       	call   80104590 <pushcli>
  c = mycpu();
80103f51:	e8 8a f7 ff ff       	call   801036e0 <mycpu>
  p = c->proc;
80103f56:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103f5c:	e8 6f 06 00 00       	call   801045d0 <popcli>
{
  struct proc *p;
  int havekids, pid;
  struct proc *curproc = myproc();
...
80103f69:	e8 02 07 00 00       	call   80104670 <acquire>
...
80103f80:	81 c3 e4 00 00 00    	add    $0xe4,%ebx
80103f86:	81 fb 54 66 11 80    	cmp    $0x80116654,%ebx
...
80103f97:	74 35                	je     80103fce <wait+0x8e>
  acquire(&ptable.lock);
  for (;;)
  {
    // Scan through table looking for exited children.
    havekids = 0;
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f99:	81 c3 e4 00 00 00    	add    $0xe4,%ebx
    {
      if (p->parent != curproc)
        continue;
      havekids = 1;
80103f9f:	b8 01 00 00 00       	mov    $0x1,%eax
  ...
  for (;;)
  {
    ...
    havekids = 0;
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103fa4:	81 fb 54 66 11 80    	cmp    $0x80116654,%ebx
...
80103fb2:	74 7a                	je     8010402e <wait+0xee>
80103fb4:	8b 46 24             	mov    0x24(%esi),%eax
80103fb7:	85 c0                	test   %eax,%eax
80103fb9:	75 73                	jne    8010402e <wait+0xee>
      release(&ptable.lock);
      return -1;
    }
...
80103fce:	85 ff                	test   %edi,%edi
      ...
      if (p->state == ZOMBIE)
      {
        // Found one.
        pid = p->pid;
80103fd0:	8b 73 10             	mov    0x10(%ebx),%esi
        if(status){
80103fd3:	74 05                	je     80103fda <wait+0x9a>
          *status = p->status;
80103fd5:	8b 43 7c             	mov    0x7c(%ebx),%eax
80103fd8:	89 07                	mov    %eax,(%edi)
        }
        kfree(p->kstack);
80103fda:	83 ec 0c             	sub    $0xc,%esp
80103fdd:	ff 73 08             	pushl  0x8(%ebx)
80103fe0:	e8 eb e2 ff ff       	call   801022d0 <kfree>
        p->kstack = 0;
        freevm(p->pgdir);
80103fe5:	5a                   	pop    %edx
80103fe6:	ff 73 04             	pushl  0x4(%ebx)
        pid = p->pid;
        if(status){
          *status = p->status;
        }
        kfree(p->kstack);
        p->kstack = 0;
80103fe9:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ff0:	e8 2b 30 00 00       	call   80107020 <freevm>
        p->pid = 0;
...
8010401c:	e8 ff 06 00 00       	call   80104720 <release>
        return pid;
...
80104024:	8d 65 f4             	lea    -0xc(%ebp),%esp
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
        p->state = UNUSED;
...
8010402d:	c3                   	ret    
    ...
    {
      if(status){
8010402e:	85 ff                	test   %edi,%edi
80104030:	74 06                	je     80104038 <wait+0xf8>
        *status = -1;
80104032:	c7 07 ff ff ff ff    	movl   $0xffffffff,(%edi)
      }
      release(&ptable.lock);
80104038:	83 ec 0c             	sub    $0xc,%esp
8010403b:	68 20 2d 11 80       	push   $0x80112d20
80104040:	e8 db 06 00 00       	call   80104720 <release>
      return -1;
...
80104048:	8d 65 f4             	lea    -0xc(%ebp),%esp
    {
      ...
      release(&ptable.lock);
      return -1;
8010404b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    }
...
myproc(void)
{
  ...
  struct proc *p;
  pushcli();
8010406c:	e8 1f 05 00 00       	call   80104590 <pushcli>
  c = mycpu();
80104071:	e8 6a f6 ff ff       	call   801036e0 <mycpu>
  p = c->proc;
80104076:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
8010407c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  popcli();
...
8010408c:	e8 df 05 00 00       	call   80104670 <acquire>
80104091:	83 c4 10             	add    $0x10,%esp
  for(;;){
    // Scan through table looking for exited children.
    havepid = 0;
80104094:	31 c9                	xor    %ecx,%ecx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104096:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
8010409b:	eb 11                	jmp    801040ae <waitpid+0x4e>
8010409d:	8d 76 00             	lea    0x0(%esi),%esi
801040a0:	81 c3 e4 00 00 00    	add    $0xe4,%ebx
801040a6:	81 fb 54 66 11 80    	cmp    $0x80116654,%ebx
801040ac:	74 42                	je     801040f0 <waitpid+0x90>
      if(p->pid != pid){
801040ae:	8b 7b 10             	mov    0x10(%ebx),%edi
801040b1:	39 f7                	cmp    %esi,%edi
801040b3:	75 eb                	jne    801040a0 <waitpid+0x40>
        continue;
      }
      havepid = 1;
      if(p->state == ZOMBIE){
801040b5:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
801040b9:	74 65                	je     80104120 <waitpid+0xc0>
        p->killed = 0;
        p->state = UNUSED;
        release(&ptable.lock);
        return pid;
      }
      else if(p->waitpid_idx < sizeof(p->waitpid)){
801040bb:	8b 83 80 00 00 00    	mov    0x80(%ebx),%eax
    havepid = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
      if(p->pid != pid){
        continue;
      ...
      havepid = 1;
801040c1:	b9 01 00 00 00       	mov    $0x1,%ecx
        p->killed = 0;
        p->state = UNUSED;
        release(&ptable.lock);
        return pid;
...
801040c6:	83 f8 4f             	cmp    $0x4f,%eax
801040c9:	77 d5                	ja     801040a0 <waitpid+0x40>

        p->waitpid[p->waitpid_idx] = p;
801040cb:	89 9c 83 84 00 00 00 	mov    %ebx,0x84(%ebx,%eax,4)
        p->waitpid_idx++;
801040d2:	83 c0 01             	add    $0x1,%eax
  ...
  for(;;){
    ...
    havepid = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040d5:	81 c3 e4 00 00 00    	add    $0xe4,%ebx
        return pid;
      }
      else if(p->waitpid_idx < sizeof(p->waitpid)){
        ...
        p->waitpid[p->waitpid_idx] = p;
        p->waitpid_idx++;
801040db:	89 43 9c             	mov    %eax,-0x64(%ebx)
  ...
  for(;;){
    ...
    havepid = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040de:	81 fb 54 66 11 80    	cmp    $0x80116654,%ebx
801040e4:	75 c8                	jne    801040ae <waitpid+0x4e>
...
801040f0:	85 c9                	test   %ecx,%ecx
801040f2:	0f 84 8f 00 00 00    	je     80104187 <waitpid+0x127>
801040f8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801040fb:	8b 50 24             	mov    0x24(%eax),%edx
801040fe:	85 d2                	test   %edx,%edx
80104100:	0f 85 81 00 00 00    	jne    80104187 <waitpid+0x127>
      release(&ptable.lock);
      return -1;
    }
...
80104109:	68 20 2d 11 80       	push   $0x80112d20
8010410e:	ff 75 e4             	pushl  -0x1c(%ebp)
80104111:	e8 6a fd ff ff       	call   80103e80 <sleep>
  }
80104116:	83 c4 10             	add    $0x10,%esp
80104119:	e9 76 ff ff ff       	jmp    80104094 <waitpid+0x34>
...
80104126:	e8 a5 e1 ff ff       	call   801022d0 <kfree>
        p->kstack = 0;
        freevm(p->pgdir);
8010412b:	59                   	pop    %ecx
...
8010412f:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104136:	e8 e5 2e 00 00       	call   80107020 <freevm>
        if(status)
8010413b:	8b 75 0c             	mov    0xc(%ebp),%esi
8010413e:	83 c4 10             	add    $0x10,%esp
80104141:	85 f6                	test   %esi,%esi
80104143:	74 08                	je     8010414d <waitpid+0xed>
          *status = p->status;
80104145:	8b 53 7c             	mov    0x7c(%ebx),%edx
...
8010418c:	74 09                	je     80104197 <waitpid+0x137>
        *status = -1;
8010418e:	8b 45 0c             	mov    0xc(%ebp),%eax
80104191:	c7 00 ff ff ff ff    	movl   $0xffffffff,(%eax)
      release(&ptable.lock);
80104197:	83 ec 0c             	sub    $0xc,%esp
      return -1;
8010419a:	bf ff ff ff ff       	mov    $0xffffffff,%edi
    ...
    if(!havepid || curproc->killed){
      if(status)
        *status = -1;
      release(&ptable.lock);
8010419f:	68 20 2d 11 80       	push   $0x80112d20
801041a4:	e8 77 05 00 00       	call   80104720 <release>
      return -1;
801041a9:	83 c4 10             	add    $0x10,%esp
801041ac:	eb cf                	jmp    8010417d <waitpid+0x11d>
...
801041d0:	05 e4 00 00 00       	add    $0xe4,%eax
801041d5:	3d 54 66 11 80       	cmp    $0x80116654,%eax
...
wakeup1(void *chan)
{
  ...
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801041ee:	05 e4 00 00 00       	add    $0xe4,%eax
801041f3:	3d 54 66 11 80       	cmp    $0x80116654,%eax
...
void wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80104205:	e9 16 05 00 00       	jmp    80104720 <release>
...
80104230:	05 e4 00 00 00       	add    $0xe4,%eax
80104235:	3d 54 66 11 80       	cmp    $0x80116654,%eax
...
80104256:	e8 c5 04 00 00       	call   80104720 <release>
      return 0;
...
80104280:	e8 9b 04 00 00       	call   80104720 <release>
  return -1;
...
801042bb:	68 3b 7d 10 80       	push   $0x80107d3b
801042c0:	e8 9b c3 ff ff       	call   80100660 <cprintf>
801042c5:	83 c4 10             	add    $0x10,%esp
801042c8:	81 c3 e4 00 00 00    	add    $0xe4,%ebx
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801042ce:	81 fb c0 66 11 80    	cmp    $0x801166c0,%ebx
...
801042e1:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
801042e4:	ba b9 79 10 80       	mov    $0x801079b9,%edx
...
801042eb:	8b 14 85 2c 7a 10 80 	mov    -0x7fef85d4(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
801042f2:	b8 b9 79 10 80       	mov    $0x801079b9,%eax
...
80104301:	68 bd 79 10 80       	push   $0x801079bd
...
80104328:	e8 03 02 00 00       	call   80104530 <getcallerpcs>
...
8010433d:	68 a1 73 10 80       	push   $0x801073a1
...
myproc(void)
{
  ...
  struct proc *p;
  pushcli();
80104368:	e8 23 02 00 00       	call   80104590 <pushcli>
  c = mycpu();
8010436d:	e8 6e f3 ff ff       	call   801036e0 <mycpu>
  p = c->proc;
80104372:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104378:	e8 53 02 00 00       	call   801045d0 <popcli>
...
int setpriority(int priority){
    ...
    if(priority < 0){
8010437d:	85 db                	test   %ebx,%ebx
8010437f:	78 3f                	js     801043c0 <setpriority+0x60>

        curproc->priority = 31;
    }
    else if(priority > 31){
80104381:	83 fb 1f             	cmp    $0x1f,%ebx
80104384:	7f 2a                	jg     801043b0 <setpriority+0x50>
...
80104386:	89 9e d4 00 00 00    	mov    %ebx,0xd4(%esi)
    }
    cprintf("Priority Set: %d\n", curproc->priority);
8010438c:	83 ec 08             	sub    $0x8,%esp
8010438f:	53                   	push   %ebx
80104390:	68 c6 79 10 80       	push   $0x801079c6
80104395:	e8 c6 c2 ff ff       	call   80100660 <cprintf>
    yield();
8010439a:	e8 91 fa ff ff       	call   80103e30 <yield>
    return 0;
}
...
801043a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        ...
        curproc->priority = 0;
801043b0:	c7 86 d4 00 00 00 00 	movl   $0x0,0xd4(%esi)
801043b7:	00 00 00 
801043ba:	31 db                	xor    %ebx,%ebx
801043bc:	eb ce                	jmp    8010438c <setpriority+0x2c>
801043be:	66 90                	xchg   %ax,%ax
    ...
    if(priority < 0){
        ...
        curproc->priority = 31;
801043c0:	c7 86 d4 00 00 00 1f 	movl   $0x1f,0xd4(%esi)
801043c7:	00 00 00 
801043ca:	bb 1f 00 00 00       	mov    $0x1f,%ebx
801043cf:	eb bb                	jmp    8010438c <setpriority+0x2c>
801043d1:	66 90                	xchg   %ax,%ax
...
801043ea:	68 44 7a 10 80       	push   $0x80107a44
...
8010442f:	e8 3c 02 00 00       	call   80104670 <acquire>
  while (lk->locked) {
...
80104453:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104459:	e8 22 f3 ff ff       	call   80103780 <myproc>
...
8010446c:	5d                   	pop    %ebp
  ...
  lk->pid = myproc()->pid;
  release(&lk->lk);
8010446d:	e9 ae 02 00 00       	jmp    80104720 <release>
...
801044a4:	e8 07 fd ff ff       	call   801041b0 <wakeup>
  release(&lk->lk);
...
801044b4:	5d                   	pop    %ebp
{
  ...
  wakeup(lk);
  release(&lk->lk);
801044b5:	e9 66 02 00 00       	jmp    80104720 <release>
...
801044d2:	e8 99 01 00 00       	call   80104670 <acquire>
...
801044e3:	e8 98 f2 ff ff       	call   80103780 <myproc>
...
801044f7:	e8 24 02 00 00       	call   80104720 <release>
  return r;
}
...
80104599:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010459a:	e8 41 f1 ff ff       	call   801036e0 <mycpu>
...
801045af:	e8 2c f1 ff ff       	call   801036e0 <mycpu>
801045b4:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
801045ba:	e8 21 f1 ff ff       	call   801036e0 <mycpu>
...
80104625:	68 66 7a 10 80       	push   $0x80107a66
...
80104632:	68 4f 7a 10 80       	push   $0x80107a4f
...
80104658:	e8 83 f0 ff ff       	call   801036e0 <mycpu>
...
80104677:	e8 14 ff ff ff       	call   80104590 <pushcli>
  if(holding(lk))
8010467c:	8b 5d 08             	mov    0x8(%ebp),%ebx
8010467f:	83 ec 0c             	sub    $0xc,%esp
80104682:	53                   	push   %ebx
80104683:	e8 b8 ff ff ff       	call   80104640 <holding>
80104688:	83 c4 10             	add    $0x10,%esp
8010468b:	85 c0                	test   %eax,%eax
8010468d:	0f 85 7d 00 00 00    	jne    80104710 <acquire+0xa0>
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
801046b4:	e8 27 f0 ff ff       	call   801036e0 <mycpu>
getcallerpcs(void *v, uint pcs[])
{
  uint *ebp;
  int i;
...
801046bb:	8d 4b 0c             	lea    0xc(%ebx),%ecx
  // past this point, to ensure that the critical section's memory
  // references happen after the lock is acquired.
  __sync_synchronize();
...
801046c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801046c8:	8d 9a 00 00 00 80    	lea    -0x80000000(%edx),%ebx
801046ce:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
801046d4:	77 1a                	ja     801046f0 <acquire+0x80>
      break;
    pcs[i] = ebp[1];     // saved %eip
801046d6:	8b 5a 04             	mov    0x4(%edx),%ebx
801046d9:	89 1c 81             	mov    %ebx,(%ecx,%eax,4)
{
  uint *ebp;
  int i;
...
801046ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(; i < 10; i++)
    pcs[i] = 0;
801046f0:	c7 04 81 00 00 00 00 	movl   $0x0,(%ecx,%eax,4)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
801046f7:	83 c0 01             	add    $0x1,%eax
801046fa:	83 f8 0a             	cmp    $0xa,%eax
801046fd:	74 e7                	je     801046e6 <acquire+0x76>
    pcs[i] = 0;
801046ff:	c7 04 81 00 00 00 00 	movl   $0x0,(%ecx,%eax,4)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80104706:	83 c0 01             	add    $0x1,%eax
80104709:	83 f8 0a             	cmp    $0xa,%eax
8010470c:	75 e2                	jne    801046f0 <acquire+0x80>
8010470e:	eb d6                	jmp    801046e6 <acquire+0x76>
void
acquire(struct spinlock *lk)
{
  pushcli(); // disable interrupts to avoid deadlock.
...
80104713:	68 6d 7a 10 80       	push   $0x80107a6d
...
8010472b:	e8 10 ff ff ff       	call   80104640 <holding>
...
8010475c:	68 75 7a 10 80       	push   $0x80107a75
80104761:	e8 0a bc ff ff       	call   80100370 <panic>
...
801049e7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801049ea:	e8 91 ed ff ff       	call   80103780 <myproc>
...
80104a27:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104a2a:	e8 51 ed ff ff       	call   80103780 <myproc>
...
80104a85:	e8 f6 ec ff ff       	call   80103780 <myproc>
...
{
  struct proc *curproc = myproc();
80104a96:	e8 e5 ec ff ff       	call   80103780 <myproc>
...
80104b74:	53                   	push   %ebx
  int num;
  struct proc *curproc = myproc();
80104b75:	e8 06 ec ff ff       	call   80103780 <myproc>
...
80104b85:	83 fa 15             	cmp    $0x15,%edx
80104b88:	77 1e                	ja     80104ba8 <syscall+0x38>
80104b8a:	8b 14 85 a0 7a 10 80 	mov    -0x7fef8560(,%eax,4),%edx
...
80104bb0:	68 7d 7a 10 80       	push   $0x80107a7d
...
80104be7:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  ...
  if((dp = nameiparent(path, name)) == 0)
80104bea:	e8 e1 d2 ff ff       	call   80101ed0 <nameiparent>
...
80104c0b:	57                   	push   %edi
80104c0c:	e8 7f cf ff ff       	call   80101b90 <dirlookup>
...
80104c1e:	e8 cd cc ff ff       	call   801018f0 <iunlockput>
    ilock(ip);
80104c23:	89 1c 24             	mov    %ebx,(%esp)
80104c26:	e8 35 ca ff ff       	call   80101660 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104c2b:	83 c4 10             	add    $0x10,%esp
80104c2e:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104c33:	75 1b                	jne    80104c50 <create+0x80>
80104c35:	66 83 7b 50 02       	cmpw   $0x2,0x50(%ebx)
80104c3a:	89 d8                	mov    %ebx,%eax
...
80104c54:	e8 97 cc ff ff       	call   801018f0 <iunlockput>
    return 0;
...
80104c7a:	e8 71 c8 ff ff       	call   801014f0 <ialloc>
...
80104c90:	e8 cb c9 ff ff       	call   80101660 <ilock>
  ip->major = major;
...
80104cb1:	e8 fa c8 ff ff       	call   801015b0 <iupdate>
...
80104cc8:	e8 23 d1 ff ff       	call   80101df0 <dirlink>
...
80104cd8:	e8 13 cc ff ff       	call   801018f0 <iunlockput>
...
80104cf2:	e9 47 ff ff ff       	jmp    80104c3e <create+0x6e>
...
80104d09:	e8 a2 c8 ff ff       	call   801015b0 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104d0e:	83 c4 0c             	add    $0xc,%esp
80104d11:	ff 73 04             	pushl  0x4(%ebx)
80104d14:	68 18 7b 10 80       	push   $0x80107b18
80104d19:	53                   	push   %ebx
80104d1a:	e8 d1 d0 ff ff       	call   80101df0 <dirlink>
...
80104d2c:	68 17 7b 10 80       	push   $0x80107b17
80104d31:	53                   	push   %ebx
80104d32:	e8 b9 d0 ff ff       	call   80101df0 <dirlink>
...
80104d41:	68 0b 7b 10 80       	push   $0x80107b0b
...
80104d4e:	68 1a 7b 10 80       	push   $0x80107b1a
...
80104d5b:	68 fc 7a 10 80       	push   $0x80107afc
...
80104d94:	e8 e7 e9 ff ff       	call   80103780 <myproc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80104dfb:	e8 80 e9 ff ff       	call   80103780 <myproc>
...
80104f33:	78 2b                	js     80104f60 <sys_close+0x40>
    return -1;
  myproc()->ofile[fd] = 0;
80104f35:	e8 46 e8 ff ff       	call   80103780 <myproc>
...
80105003:	e8 a8 ce ff ff       	call   80101eb0 <namei>
...
8010504b:	e8 80 ce ff ff       	call   80101ed0 <nameiparent>
...
80105073:	e8 78 cd ff ff       	call   80101df0 <dirlink>
...
80105083:	e8 68 c8 ff ff       	call   801018f0 <iunlockput>
  iput(ip);
...
801050ac:	e8 3f c8 ff ff       	call   801018f0 <iunlockput>
    goto bad;
...
801050cd:	e8 1e c8 ff ff       	call   801018f0 <iunlockput>
  end_op();
801050d2:	e8 d9 da ff ff       	call   80102bb0 <end_op>
  return -1;
...
801050f4:	e8 f7 c7 ff ff       	call   801018f0 <iunlockput>
    end_op();
801050f9:	e8 b2 da ff ff       	call   80102bb0 <end_op>
    return -1;
...
80105106:	eb 92                	jmp    8010509a <sys_link+0xda>
  ...
  if((ip = namei(old)) == 0){
    end_op();
80105108:	e8 a3 da ff ff       	call   80102bb0 <end_op>
    return -1;
...
8010513f:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  ...
  begin_op();
80105142:	e8 f9 d9 ff ff       	call   80102b40 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105147:	83 ec 08             	sub    $0x8,%esp
8010514a:	53                   	push   %ebx
8010514b:	ff 75 c0             	pushl  -0x40(%ebp)
8010514e:	e8 7d cd ff ff       	call   80101ed0 <nameiparent>
...
8010516d:	58                   	pop    %eax
8010516e:	5a                   	pop    %edx
8010516f:	68 18 7b 10 80       	push   $0x80107b18
80105174:	53                   	push   %ebx
80105175:	e8 f6 c9 ff ff       	call   80101b70 <namecmp>
...
80105188:	68 17 7b 10 80       	push   $0x80107b17
8010518d:	53                   	push   %ebx
8010518e:	e8 dd c9 ff ff       	call   80101b70 <namecmp>
...
801051a7:	e8 e4 c9 ff ff       	call   80101b90 <dirlookup>
...
801051f0:	e8 4b c8 ff ff       	call   80101a40 <writei>
...
80105212:	e8 d9 c6 ff ff       	call   801018f0 <iunlockput>
...
80105227:	e8 c4 c6 ff ff       	call   801018f0 <iunlockput>

  end_op();
8010522c:	e8 7f d9 ff ff       	call   80102bb0 <end_op>
...
80105261:	e8 da c6 ff ff       	call   80101940 <readi>
...
80105279:	e8 72 c6 ff ff       	call   801018f0 <iunlockput>
    goto bad;
...
80105287:	e8 64 c6 ff ff       	call   801018f0 <iunlockput>
  end_op();
...
801052c6:	e9 6b ff ff ff       	jmp    80105236 <sys_unlink+0x116>
  ...
  if((dp = nameiparent(path, name)) == 0){
    end_op();
801052cb:	e8 e0 d8 ff ff       	call   80102bb0 <end_op>
    return -1;
...
801052dd:	68 3c 7b 10 80       	push   $0x80107b3c
...
801052ea:	68 4e 7b 10 80       	push   $0x80107b4e
...
801052f7:	68 2a 7b 10 80       	push   $0x80107b2a
...
80105342:	0f 88 85 00 00 00    	js     801053cd <sys_open+0xbd>
  ...
  begin_op();
80105348:	e8 f3 d7 ff ff       	call   80102b40 <begin_op>
...
8010535d:	e8 4e cb ff ff       	call   80101eb0 <namei>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80105393:	e8 e8 e3 ff ff       	call   80103780 <myproc>
80105398:	90                   	nop
...
801053c0:	e8 2b c5 ff ff       	call   801018f0 <iunlockput>
    end_op();
801053c5:	e8 e6 d7 ff ff       	call   80102bb0 <end_op>
    return -1;
...
801053fb:	75 89                	jne    80105386 <sys_open+0x76>
      end_op();
801053fd:	e8 ae d7 ff ff       	call   80102bb0 <end_op>
      return -1;
...
80105473:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105476:	e8 c5 d6 ff ff       	call   80102b40 <begin_op>
...
801054af:	e8 3c c4 ff ff       	call   801018f0 <iunlockput>
  end_op();
801054b4:	e8 f7 d6 ff ff       	call   80102bb0 <end_op>
  return 0;
...
801054d3:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
801054d6:	e8 65 d6 ff ff       	call   80102b40 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
8010553e:	e8 ad c3 ff ff       	call   801018f0 <iunlockput>
  end_op();
80105543:	e8 68 d6 ff ff       	call   80102bb0 <end_op>
  return 0;
...
8010554f:	90                   	nop
  ...
  if((argstr(0, &path)) < 0 ||
     ...
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
80105550:	e8 5b d6 ff ff       	call   80102bb0 <end_op>
    return -1;
...
8010556d:	89 c6                	mov    %eax,%esi
  ...
  begin_op();
8010556f:	e8 cc d5 ff ff       	call   80102b40 <begin_op>
...
8010558f:	e8 1c c9 ff ff       	call   80101eb0 <namei>
...
801055a1:	e8 ba c0 ff ff       	call   80101660 <ilock>
  if(ip->type != T_DIR){
...
801055b4:	e8 87 c1 ff ff       	call   80101740 <iunlock>
  iput(curproc->cwd);
801055b9:	58                   	pop    %eax
801055ba:	ff 76 68             	pushl  0x68(%esi)
801055bd:	e8 ce c1 ff ff       	call   80101790 <iput>
  end_op();
801055c2:	e8 e9 d5 ff ff       	call   80102bb0 <end_op>
  curproc->cwd = ip;
...
801055e4:	e8 07 c3 ff ff       	call   801018f0 <iunlockput>
    end_op();
801055e9:	e8 c2 d5 ff ff       	call   80102bb0 <end_op>
    return -1;
...
801055f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
    end_op();
80105600:	e8 ab d5 ff ff       	call   80102bb0 <end_op>
    return -1;
...
80105718:	e8 c3 da ff ff       	call   801031e0 <pipealloc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80105729:	e8 52 e0 ff ff       	call   80103780 <myproc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80105772:	e8 09 e0 ff ff       	call   80103780 <myproc>
...
{
  return fork();
801057c4:	e9 57 e1 ff ff       	jmp    80103920 <fork>
...
801057dc:	e8 9f f2 ff ff       	call   80104a80 <argint>
801057e1:	83 c4 10             	add    $0x10,%esp
801057e4:	85 c0                	test   %eax,%eax
801057e6:	78 18                	js     80105800 <sys_exit+0x30>
    return -1;
  exit(n);
801057e8:	83 ec 0c             	sub    $0xc,%esp
801057eb:	ff 75 f4             	pushl  -0xc(%ebp)
801057ee:	e8 ad e4 ff ff       	call   80103ca0 <exit>
...
8010581e:	e8 ad f2 ff ff       	call   80104ad0 <argptr>
80105823:	83 c4 10             	add    $0x10,%esp
80105826:	85 c0                	test   %eax,%eax
80105828:	78 16                	js     80105840 <sys_wait+0x30>
    return -1;
  return wait(status0);
8010582a:	83 ec 0c             	sub    $0xc,%esp
8010582d:	ff 75 f4             	pushl  -0xc(%ebp)
80105830:	e8 0b e7 ff ff       	call   80103f40 <wait>
...
80105888:	e8 f3 f1 ff ff       	call   80104a80 <argint>
8010588d:	83 c4 10             	add    $0x10,%esp
80105890:	85 c0                	test   %eax,%eax
80105892:	78 1c                	js     801058b0 <sys_waitpid+0x60>
    return -1;
...
801058a0:	e8 bb e7 ff ff       	call   80104060 <waitpid>
...
801058cc:	e8 af f1 ff ff       	call   80104a80 <argint>
...
801058de:	e8 2d e9 ff ff       	call   80104210 <kill>
...
80105903:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105906:	e8 75 de ff ff       	call   80103780 <myproc>
...
8010591d:	e8 5e f1 ff ff       	call   80104a80 <argint>
...
80105936:	e8 65 df ff ff       	call   801038a0 <growproc>
...
80105980:	68 60 66 11 80       	push   $0x80116660
80105985:	e8 e6 ec ff ff       	call   80104670 <acquire>
  ticks0 = ticks;
...
8010598d:	83 c4 10             	add    $0x10,%esp
  ...
  acquire(&tickslock);
  ticks0 = ticks;
80105990:	8b 1d a0 6e 11 80    	mov    0x80116ea0,%ebx
  while(ticks - ticks0 < n){
...
801059a3:	68 60 66 11 80       	push   $0x80116660
801059a8:	68 a0 6e 11 80       	push   $0x80116ea0
801059ad:	e8 ce e4 ff ff       	call   80103e80 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801059b2:	a1 a0 6e 11 80       	mov    0x80116ea0,%eax
...
801059bf:	73 2f                	jae    801059f0 <sys_sleep+0x90>
    if(myproc()->killed){
801059c1:	e8 ba dd ff ff       	call   80103780 <myproc>
...
801059d0:	68 60 66 11 80       	push   $0x80116660
801059d5:	e8 46 ed ff ff       	call   80104720 <release>
      return -1;
...
801059f3:	68 60 66 11 80       	push   $0x80116660
801059f8:	e8 23 ed ff ff       	call   80104720 <release>
  return 0;
...
80105a14:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105a17:	68 60 66 11 80       	push   $0x80116660
80105a1c:	e8 4f ec ff ff       	call   80104670 <acquire>
  xticks = ticks;
80105a21:	8b 1d a0 6e 11 80    	mov    0x80116ea0,%ebx
  release(&tickslock);
80105a27:	c7 04 24 60 66 11 80 	movl   $0x80116660,(%esp)
80105a2e:	e8 ed ec ff ff       	call   80104720 <release>
  return xticks;
}
...
80105a4c:	e8 2f f0 ff ff       	call   80104a80 <argint>
80105a51:	83 c4 10             	add    $0x10,%esp
80105a54:	85 c0                	test   %eax,%eax
80105a56:	78 18                	js     80105a70 <sys_setpriority+0x30>
    return -1;

  setpriority(priority);
80105a58:	83 ec 0c             	sub    $0xc,%esp
80105a5b:	ff 75 f4             	pushl  -0xc(%ebp)
80105a5e:	e8 fd e8 ff ff       	call   80104360 <setpriority>
...
80105a78:	06                   	push   %es
  pushl %fs
80105a79:	0f a0                	push   %fs
  pushl %gs
80105a7b:	0f a8                	push   %gs
  pushal
80105a7d:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105a7e:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105a82:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105a84:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105a86:	54                   	push   %esp
  call trap
80105a87:	e8 e4 00 00 00       	call   80105b70 <trap>
  addl $4, %esp
80105a8c:	83 c4 04             	add    $0x4,%esp
...
80105a8f:	61                   	popa   
  popl %gs
80105a90:	0f a9                	pop    %gs
  popl %fs
80105a92:	0f a1                	pop    %fs
  popl %es
80105a94:	07                   	pop    %es
  popl %ds
80105a95:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105a96:	83 c4 08             	add    $0x8,%esp
  iret
80105a99:	cf                   	iret   
...
80105aa8:	8b 14 85 08 a0 10 80 	mov    -0x7fef5ff8(,%eax,4),%edx
80105aaf:	b9 08 00 00 00       	mov    $0x8,%ecx
80105ab4:	c6 04 c5 a4 66 11 80 	movb   $0x0,-0x7fee995c(,%eax,8)
80105abb:	00 
80105abc:	66 89 0c c5 a2 66 11 	mov    %cx,-0x7fee995e(,%eax,8)
80105ac3:	80 
80105ac4:	c6 04 c5 a5 66 11 80 	movb   $0x8e,-0x7fee995b(,%eax,8)
80105acb:	8e 
80105acc:	66 89 14 c5 a0 66 11 	mov    %dx,-0x7fee9960(,%eax,8)
80105ad3:	80 
80105ad4:	c1 ea 10             	shr    $0x10,%edx
80105ad7:	66 89 14 c5 a6 66 11 	mov    %dx,-0x7fee995a(,%eax,8)
80105ade:	80 
void
tvinit(void)
{
...
80105ae2:	3d 00 01 00 00       	cmp    $0x100,%eax
80105ae7:	75 bf                	jne    80105aa8 <tvinit+0x8>
...
80105aea:	ba 08 00 00 00       	mov    $0x8,%edx
struct spinlock tickslock;
uint ticks;
...
80105af1:	83 ec 10             	sub    $0x10,%esp
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105af4:	a1 08 a1 10 80       	mov    0x8010a108,%eax

  initlock(&tickslock, "time");
80105af9:	68 5d 7b 10 80       	push   $0x80107b5d
80105afe:	68 60 66 11 80       	push   $0x80116660
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105b03:	66 89 15 a2 68 11 80 	mov    %dx,0x801168a2
80105b0a:	c6 05 a4 68 11 80 00 	movb   $0x0,0x801168a4
80105b11:	66 a3 a0 68 11 80    	mov    %ax,0x801168a0
80105b17:	c1 e8 10             	shr    $0x10,%eax
80105b1a:	c6 05 a5 68 11 80 ef 	movb   $0xef,0x801168a5
80105b21:	66 a3 a6 68 11 80    	mov    %ax,0x801168a6

  initlock(&tickslock, "time");
80105b27:	e8 e4 e9 ff ff       	call   80104510 <initlock>
}
80105b2c:	83 c4 10             	add    $0x10,%esp
80105b2f:	c9                   	leave  
80105b30:	c3                   	ret    
80105b31:	eb 0d                	jmp    80105b40 <idtinit>
80105b33:	90                   	nop
80105b34:	90                   	nop
80105b35:	90                   	nop
80105b36:	90                   	nop
...
80105b4b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105b4f:	b8 a0 66 11 80       	mov    $0x801166a0,%eax
...
80105b79:	8b 7d 08             	mov    0x8(%ebp),%edi
  if(tf->trapno == T_SYSCALL){
80105b7c:	8b 47 30             	mov    0x30(%edi),%eax
80105b7f:	83 f8 40             	cmp    $0x40,%eax
80105b82:	0f 84 98 01 00 00    	je     80105d20 <trap+0x1b0>
    if(myproc()->killed)
      exit(PASS_STATUS);
    return;
  }
...
80105b8e:	77 10                	ja     80105ba0 <trap+0x30>
80105b90:	ff 24 85 04 7c 10 80 	jmp    *-0x7fef83fc(,%eax,4)
...
80105ba7:	0f 84 f7 01 00 00    	je     80105da4 <trap+0x234>
80105bad:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
80105bb1:	0f 84 ed 01 00 00    	je     80105da4 <trap+0x234>
...
80105bba:	8b 57 38             	mov    0x38(%edi),%edx
80105bbd:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80105bc0:	89 55 dc             	mov    %edx,-0x24(%ebp)
80105bc3:	e8 98 db ff ff       	call   80103760 <cpuid>
80105bc8:	8b 77 34             	mov    0x34(%edi),%esi
80105bcb:	8b 5f 30             	mov    0x30(%edi),%ebx
80105bce:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105bd1:	e8 aa db ff ff       	call   80103780 <myproc>
...
80105be5:	52                   	push   %edx
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105be6:	8b 55 e0             	mov    -0x20(%ebp),%edx
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105be9:	ff 75 e4             	pushl  -0x1c(%ebp)
80105bec:	56                   	push   %esi
80105bed:	53                   	push   %ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105bee:	83 c2 6c             	add    $0x6c,%edx
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
...
80105bf2:	ff 70 10             	pushl  0x10(%eax)
80105bf5:	68 c0 7b 10 80       	push   $0x80107bc0
...
80105c02:	e8 79 db ff ff       	call   80103780 <myproc>
...
80105c17:	74 0c                	je     80105c25 <trap+0xb5>
80105c19:	e8 62 db ff ff       	call   80103780 <myproc>
80105c1e:	8b 50 24             	mov    0x24(%eax),%edx
80105c21:	85 d2                	test   %edx,%edx
80105c23:	75 4b                	jne    80105c70 <trap+0x100>
    exit(PASS_STATUS);

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105c25:	e8 56 db ff ff       	call   80103780 <myproc>
80105c2a:	85 c0                	test   %eax,%eax
80105c2c:	74 0b                	je     80105c39 <trap+0xc9>
80105c2e:	e8 4d db ff ff       	call   80103780 <myproc>
80105c33:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105c37:	74 57                	je     80105c90 <trap+0x120>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c39:	e8 42 db ff ff       	call   80103780 <myproc>
80105c3e:	85 c0                	test   %eax,%eax
80105c40:	74 1d                	je     80105c5f <trap+0xef>
80105c42:	e8 39 db ff ff       	call   80103780 <myproc>
80105c47:	8b 40 24             	mov    0x24(%eax),%eax
80105c4a:	85 c0                	test   %eax,%eax
80105c4c:	74 11                	je     80105c5f <trap+0xef>
80105c4e:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
80105c52:	83 e0 03             	and    $0x3,%eax
80105c55:	66 83 f8 03          	cmp    $0x3,%ax
80105c59:	0f 84 ea 00 00 00    	je     80105d49 <trap+0x1d9>
    exit(PASS_STATUS);
}
...
80105c69:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  // until it gets to the regular system call return.)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c70:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
80105c74:	83 e0 03             	and    $0x3,%eax
80105c77:	66 83 f8 03          	cmp    $0x3,%ax
80105c7b:	75 a8                	jne    80105c25 <trap+0xb5>
    exit(PASS_STATUS);
80105c7d:	83 ec 0c             	sub    $0xc,%esp
80105c80:	6a 01                	push   $0x1
80105c82:	e8 19 e0 ff ff       	call   80103ca0 <exit>
80105c87:	83 c4 10             	add    $0x10,%esp
80105c8a:	eb 99                	jmp    80105c25 <trap+0xb5>
...
80105c94:	75 a3                	jne    80105c39 <trap+0xc9>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
80105c96:	e8 95 e1 ff ff       	call   80103e30 <yield>
80105c9b:	eb 9c                	jmp    80105c39 <trap+0xc9>
80105c9d:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105ca0:	e8 bb da ff ff       	call   80103760 <cpuid>
80105ca5:	85 c0                	test   %eax,%eax
80105ca7:	0f 84 c3 00 00 00    	je     80105d70 <trap+0x200>
    }
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE:
...
80105cad:	e8 4e ca ff ff       	call   80102700 <lapiceoi>
    break;
80105cb2:	e9 59 ff ff ff       	jmp    80105c10 <trap+0xa0>
...
80105cb9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80105cc0:	e8 fb c8 ff ff       	call   801025c0 <kbdintr>
    lapiceoi();
80105cc5:	e8 36 ca ff ff       	call   80102700 <lapiceoi>
    break;
80105cca:	e9 41 ff ff ff       	jmp    80105c10 <trap+0xa0>
80105ccf:	90                   	nop
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80105cd0:	e8 6b 02 00 00       	call   80105f40 <uartintr>
    lapiceoi();
80105cd5:	e8 26 ca ff ff       	call   80102700 <lapiceoi>
    break;
80105cda:	e9 31 ff ff ff       	jmp    80105c10 <trap+0xa0>
80105cdf:	90                   	nop
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105ce0:	0f b7 5f 3c          	movzwl 0x3c(%edi),%ebx
80105ce4:	8b 77 38             	mov    0x38(%edi),%esi
80105ce7:	e8 74 da ff ff       	call   80103760 <cpuid>
80105cec:	56                   	push   %esi
80105ced:	53                   	push   %ebx
80105cee:	50                   	push   %eax
80105cef:	68 68 7b 10 80       	push   $0x80107b68
...
80105d01:	e9 0a ff ff ff       	jmp    80105c10 <trap+0xa0>
...
80105d09:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105d10:	e8 2b c3 ff ff       	call   80102040 <ideintr>
80105d15:	eb 96                	jmp    80105cad <trap+0x13d>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
80105d20:	e8 5b da ff ff       	call   80103780 <myproc>
80105d25:	8b 58 24             	mov    0x24(%eax),%ebx
80105d28:	85 db                	test   %ebx,%ebx
80105d2a:	75 34                	jne    80105d60 <trap+0x1f0>
      exit(PASS_STATUS);
    myproc()->tf = tf;
80105d2c:	e8 4f da ff ff       	call   80103780 <myproc>
80105d31:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105d34:	e8 37 ee ff ff       	call   80104b70 <syscall>
    if(myproc()->killed)
80105d39:	e8 42 da ff ff       	call   80103780 <myproc>
80105d3e:	8b 48 24             	mov    0x24(%eax),%ecx
80105d41:	85 c9                	test   %ecx,%ecx
80105d43:	0f 84 16 ff ff ff    	je     80105c5f <trap+0xef>
      exit(PASS_STATUS);
80105d49:	c7 45 08 01 00 00 00 	movl   $0x1,0x8(%ebp)
    yield();
...
80105d56:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit(PASS_STATUS);
80105d57:	e9 44 df ff ff       	jmp    80103ca0 <exit>
...
80105d65:	e8 36 df ff ff       	call   80103ca0 <exit>
80105d6a:	83 c4 10             	add    $0x10,%esp
80105d6d:	eb bd                	jmp    80105d2c <trap+0x1bc>
80105d6f:	90                   	nop
  }
...
80105d73:	68 60 66 11 80       	push   $0x80116660
80105d78:	e8 f3 e8 ff ff       	call   80104670 <acquire>
      ticks++;
      wakeup(&ticks);
80105d7d:	c7 04 24 a0 6e 11 80 	movl   $0x80116ea0,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
80105d84:	83 05 a0 6e 11 80 01 	addl   $0x1,0x80116ea0
      wakeup(&ticks);
80105d8b:	e8 20 e4 ff ff       	call   801041b0 <wakeup>
      release(&tickslock);
80105d90:	c7 04 24 60 66 11 80 	movl   $0x80116660,(%esp)
80105d97:	e8 84 e9 ff ff       	call   80104720 <release>
80105d9c:	83 c4 10             	add    $0x10,%esp
80105d9f:	e9 09 ff ff ff       	jmp    80105cad <trap+0x13d>
...
80105daa:	e8 b1 d9 ff ff       	call   80103760 <cpuid>
...
80105db8:	68 8c 7b 10 80       	push   $0x80107b8c
80105dbd:	e8 9e a8 ff ff       	call   80100660 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80105dc2:	83 c4 14             	add    $0x14,%esp
80105dc5:	68 62 7b 10 80       	push   $0x80107b62
...
80105e25:	e8 f6 c8 ff ff       	call   80102720 <microdelay>
{
  int i;
...
80105ebf:	bb 84 7c 10 80       	mov    $0x80107c84,%ebx
80105ec4:	6a 00                	push   $0x0
80105ec6:	6a 04                	push   $0x4
80105ec8:	e8 c3 c3 ff ff       	call   80102290 <ioapicenable>
...
80105f57:	6a 00                	push   $0x0
  jmp alltraps
80105f59:	e9 19 fb ff ff       	jmp    80105a77 <alltraps>
...
80105f60:	6a 01                	push   $0x1
  jmp alltraps
80105f62:	e9 10 fb ff ff       	jmp    80105a77 <alltraps>
...
80105f69:	6a 02                	push   $0x2
  jmp alltraps
80105f6b:	e9 07 fb ff ff       	jmp    80105a77 <alltraps>
...
80105f72:	6a 03                	push   $0x3
  jmp alltraps
80105f74:	e9 fe fa ff ff       	jmp    80105a77 <alltraps>
...
80105f7b:	6a 04                	push   $0x4
  jmp alltraps
80105f7d:	e9 f5 fa ff ff       	jmp    80105a77 <alltraps>
...
80105f84:	6a 05                	push   $0x5
  jmp alltraps
80105f86:	e9 ec fa ff ff       	jmp    80105a77 <alltraps>
...
80105f8d:	6a 06                	push   $0x6
  jmp alltraps
80105f8f:	e9 e3 fa ff ff       	jmp    80105a77 <alltraps>
...
80105f96:	6a 07                	push   $0x7
  jmp alltraps
80105f98:	e9 da fa ff ff       	jmp    80105a77 <alltraps>
...
80105f9d:	6a 08                	push   $0x8
  jmp alltraps
80105f9f:	e9 d3 fa ff ff       	jmp    80105a77 <alltraps>
...
80105fa6:	6a 09                	push   $0x9
  jmp alltraps
80105fa8:	e9 ca fa ff ff       	jmp    80105a77 <alltraps>
...
80105fad:	6a 0a                	push   $0xa
  jmp alltraps
80105faf:	e9 c3 fa ff ff       	jmp    80105a77 <alltraps>
...
80105fb4:	6a 0b                	push   $0xb
  jmp alltraps
80105fb6:	e9 bc fa ff ff       	jmp    80105a77 <alltraps>
...
80105fbb:	6a 0c                	push   $0xc
  jmp alltraps
80105fbd:	e9 b5 fa ff ff       	jmp    80105a77 <alltraps>
...
80105fc2:	6a 0d                	push   $0xd
  jmp alltraps
80105fc4:	e9 ae fa ff ff       	jmp    80105a77 <alltraps>
...
80105fc9:	6a 0e                	push   $0xe
  jmp alltraps
80105fcb:	e9 a7 fa ff ff       	jmp    80105a77 <alltraps>
...
80105fd2:	6a 0f                	push   $0xf
  jmp alltraps
80105fd4:	e9 9e fa ff ff       	jmp    80105a77 <alltraps>
...
80105fdb:	6a 10                	push   $0x10
  jmp alltraps
80105fdd:	e9 95 fa ff ff       	jmp    80105a77 <alltraps>
...
80105fe2:	6a 11                	push   $0x11
  jmp alltraps
80105fe4:	e9 8e fa ff ff       	jmp    80105a77 <alltraps>
...
80105feb:	6a 12                	push   $0x12
  jmp alltraps
80105fed:	e9 85 fa ff ff       	jmp    80105a77 <alltraps>
...
80105ff4:	6a 13                	push   $0x13
  jmp alltraps
80105ff6:	e9 7c fa ff ff       	jmp    80105a77 <alltraps>
...
80105ffd:	6a 14                	push   $0x14
  jmp alltraps
80105fff:	e9 73 fa ff ff       	jmp    80105a77 <alltraps>
...
80106006:	6a 15                	push   $0x15
  jmp alltraps
80106008:	e9 6a fa ff ff       	jmp    80105a77 <alltraps>
...
8010600f:	6a 16                	push   $0x16
  jmp alltraps
80106011:	e9 61 fa ff ff       	jmp    80105a77 <alltraps>
...
80106018:	6a 17                	push   $0x17
  jmp alltraps
8010601a:	e9 58 fa ff ff       	jmp    80105a77 <alltraps>
...
80106021:	6a 18                	push   $0x18
  jmp alltraps
80106023:	e9 4f fa ff ff       	jmp    80105a77 <alltraps>
...
8010602a:	6a 19                	push   $0x19
  jmp alltraps
8010602c:	e9 46 fa ff ff       	jmp    80105a77 <alltraps>
...
80106033:	6a 1a                	push   $0x1a
  jmp alltraps
80106035:	e9 3d fa ff ff       	jmp    80105a77 <alltraps>
...
8010603c:	6a 1b                	push   $0x1b
  jmp alltraps
8010603e:	e9 34 fa ff ff       	jmp    80105a77 <alltraps>
...
80106045:	6a 1c                	push   $0x1c
  jmp alltraps
80106047:	e9 2b fa ff ff       	jmp    80105a77 <alltraps>
...
8010604e:	6a 1d                	push   $0x1d
  jmp alltraps
80106050:	e9 22 fa ff ff       	jmp    80105a77 <alltraps>
...
80106057:	6a 1e                	push   $0x1e
  jmp alltraps
80106059:	e9 19 fa ff ff       	jmp    80105a77 <alltraps>
...
80106060:	6a 1f                	push   $0x1f
  jmp alltraps
80106062:	e9 10 fa ff ff       	jmp    80105a77 <alltraps>
...
80106069:	6a 20                	push   $0x20
  jmp alltraps
8010606b:	e9 07 fa ff ff       	jmp    80105a77 <alltraps>
...
80106072:	6a 21                	push   $0x21
  jmp alltraps
80106074:	e9 fe f9 ff ff       	jmp    80105a77 <alltraps>
...
8010607b:	6a 22                	push   $0x22
  jmp alltraps
8010607d:	e9 f5 f9 ff ff       	jmp    80105a77 <alltraps>
...
80106084:	6a 23                	push   $0x23
  jmp alltraps
80106086:	e9 ec f9 ff ff       	jmp    80105a77 <alltraps>
...
8010608d:	6a 24                	push   $0x24
  jmp alltraps
8010608f:	e9 e3 f9 ff ff       	jmp    80105a77 <alltraps>
...
80106096:	6a 25                	push   $0x25
  jmp alltraps
80106098:	e9 da f9 ff ff       	jmp    80105a77 <alltraps>
...
8010609f:	6a 26                	push   $0x26
  jmp alltraps
801060a1:	e9 d1 f9 ff ff       	jmp    80105a77 <alltraps>
...
801060a8:	6a 27                	push   $0x27
  jmp alltraps
801060aa:	e9 c8 f9 ff ff       	jmp    80105a77 <alltraps>
...
801060b1:	6a 28                	push   $0x28
  jmp alltraps
801060b3:	e9 bf f9 ff ff       	jmp    80105a77 <alltraps>
...
801060ba:	6a 29                	push   $0x29
  jmp alltraps
801060bc:	e9 b6 f9 ff ff       	jmp    80105a77 <alltraps>
...
801060c3:	6a 2a                	push   $0x2a
  jmp alltraps
801060c5:	e9 ad f9 ff ff       	jmp    80105a77 <alltraps>
...
801060cc:	6a 2b                	push   $0x2b
  jmp alltraps
801060ce:	e9 a4 f9 ff ff       	jmp    80105a77 <alltraps>
...
801060d5:	6a 2c                	push   $0x2c
  jmp alltraps
801060d7:	e9 9b f9 ff ff       	jmp    80105a77 <alltraps>
...
801060de:	6a 2d                	push   $0x2d
  jmp alltraps
801060e0:	e9 92 f9 ff ff       	jmp    80105a77 <alltraps>
...
801060e7:	6a 2e                	push   $0x2e
  jmp alltraps
801060e9:	e9 89 f9 ff ff       	jmp    80105a77 <alltraps>
...
801060f0:	6a 2f                	push   $0x2f
  jmp alltraps
801060f2:	e9 80 f9 ff ff       	jmp    80105a77 <alltraps>
...
801060f9:	6a 30                	push   $0x30
  jmp alltraps
801060fb:	e9 77 f9 ff ff       	jmp    80105a77 <alltraps>
...
80106102:	6a 31                	push   $0x31
  jmp alltraps
80106104:	e9 6e f9 ff ff       	jmp    80105a77 <alltraps>
...
8010610b:	6a 32                	push   $0x32
  jmp alltraps
8010610d:	e9 65 f9 ff ff       	jmp    80105a77 <alltraps>
...
80106114:	6a 33                	push   $0x33
  jmp alltraps
80106116:	e9 5c f9 ff ff       	jmp    80105a77 <alltraps>
...
8010611d:	6a 34                	push   $0x34
  jmp alltraps
8010611f:	e9 53 f9 ff ff       	jmp    80105a77 <alltraps>
...
80106126:	6a 35                	push   $0x35
  jmp alltraps
80106128:	e9 4a f9 ff ff       	jmp    80105a77 <alltraps>
...
8010612f:	6a 36                	push   $0x36
  jmp alltraps
80106131:	e9 41 f9 ff ff       	jmp    80105a77 <alltraps>
...
80106138:	6a 37                	push   $0x37
  jmp alltraps
8010613a:	e9 38 f9 ff ff       	jmp    80105a77 <alltraps>
...
80106141:	6a 38                	push   $0x38
  jmp alltraps
80106143:	e9 2f f9 ff ff       	jmp    80105a77 <alltraps>
...
8010614a:	6a 39                	push   $0x39
  jmp alltraps
8010614c:	e9 26 f9 ff ff       	jmp    80105a77 <alltraps>
...
80106153:	6a 3a                	push   $0x3a
  jmp alltraps
80106155:	e9 1d f9 ff ff       	jmp    80105a77 <alltraps>
...
8010615c:	6a 3b                	push   $0x3b
  jmp alltraps
8010615e:	e9 14 f9 ff ff       	jmp    80105a77 <alltraps>
...
80106165:	6a 3c                	push   $0x3c
  jmp alltraps
80106167:	e9 0b f9 ff ff       	jmp    80105a77 <alltraps>
...
8010616e:	6a 3d                	push   $0x3d
  jmp alltraps
80106170:	e9 02 f9 ff ff       	jmp    80105a77 <alltraps>
...
80106177:	6a 3e                	push   $0x3e
  jmp alltraps
80106179:	e9 f9 f8 ff ff       	jmp    80105a77 <alltraps>
...
80106180:	6a 3f                	push   $0x3f
  jmp alltraps
80106182:	e9 f0 f8 ff ff       	jmp    80105a77 <alltraps>
...
80106189:	6a 40                	push   $0x40
  jmp alltraps
8010618b:	e9 e7 f8 ff ff       	jmp    80105a77 <alltraps>
...
80106192:	6a 41                	push   $0x41
  jmp alltraps
80106194:	e9 de f8 ff ff       	jmp    80105a77 <alltraps>
...
8010619b:	6a 42                	push   $0x42
  jmp alltraps
8010619d:	e9 d5 f8 ff ff       	jmp    80105a77 <alltraps>
...
801061a4:	6a 43                	push   $0x43
  jmp alltraps
801061a6:	e9 cc f8 ff ff       	jmp    80105a77 <alltraps>
...
801061ad:	6a 44                	push   $0x44
  jmp alltraps
801061af:	e9 c3 f8 ff ff       	jmp    80105a77 <alltraps>
...
801061b6:	6a 45                	push   $0x45
  jmp alltraps
801061b8:	e9 ba f8 ff ff       	jmp    80105a77 <alltraps>
...
801061bf:	6a 46                	push   $0x46
  jmp alltraps
801061c1:	e9 b1 f8 ff ff       	jmp    80105a77 <alltraps>
...
801061c8:	6a 47                	push   $0x47
  jmp alltraps
801061ca:	e9 a8 f8 ff ff       	jmp    80105a77 <alltraps>
...
801061d1:	6a 48                	push   $0x48
  jmp alltraps
801061d3:	e9 9f f8 ff ff       	jmp    80105a77 <alltraps>
...
801061da:	6a 49                	push   $0x49
  jmp alltraps
801061dc:	e9 96 f8 ff ff       	jmp    80105a77 <alltraps>
...
801061e3:	6a 4a                	push   $0x4a
  jmp alltraps
801061e5:	e9 8d f8 ff ff       	jmp    80105a77 <alltraps>
...
801061ec:	6a 4b                	push   $0x4b
  jmp alltraps
801061ee:	e9 84 f8 ff ff       	jmp    80105a77 <alltraps>
...
801061f5:	6a 4c                	push   $0x4c
  jmp alltraps
801061f7:	e9 7b f8 ff ff       	jmp    80105a77 <alltraps>
...
801061fe:	6a 4d                	push   $0x4d
  jmp alltraps
80106200:	e9 72 f8 ff ff       	jmp    80105a77 <alltraps>
...
80106207:	6a 4e                	push   $0x4e
  jmp alltraps
80106209:	e9 69 f8 ff ff       	jmp    80105a77 <alltraps>
...
80106210:	6a 4f                	push   $0x4f
  jmp alltraps
80106212:	e9 60 f8 ff ff       	jmp    80105a77 <alltraps>
...
80106219:	6a 50                	push   $0x50
  jmp alltraps
8010621b:	e9 57 f8 ff ff       	jmp    80105a77 <alltraps>
...
80106222:	6a 51                	push   $0x51
  jmp alltraps
80106224:	e9 4e f8 ff ff       	jmp    80105a77 <alltraps>
...
8010622b:	6a 52                	push   $0x52
  jmp alltraps
8010622d:	e9 45 f8 ff ff       	jmp    80105a77 <alltraps>
...
80106234:	6a 53                	push   $0x53
  jmp alltraps
80106236:	e9 3c f8 ff ff       	jmp    80105a77 <alltraps>
...
8010623d:	6a 54                	push   $0x54
  jmp alltraps
8010623f:	e9 33 f8 ff ff       	jmp    80105a77 <alltraps>
...
80106246:	6a 55                	push   $0x55
  jmp alltraps
80106248:	e9 2a f8 ff ff       	jmp    80105a77 <alltraps>
...
8010624f:	6a 56                	push   $0x56
  jmp alltraps
80106251:	e9 21 f8 ff ff       	jmp    80105a77 <alltraps>
...
80106258:	6a 57                	push   $0x57
  jmp alltraps
8010625a:	e9 18 f8 ff ff       	jmp    80105a77 <alltraps>
...
80106261:	6a 58                	push   $0x58
  jmp alltraps
80106263:	e9 0f f8 ff ff       	jmp    80105a77 <alltraps>
...
8010626a:	6a 59                	push   $0x59
  jmp alltraps
8010626c:	e9 06 f8 ff ff       	jmp    80105a77 <alltraps>
...
80106273:	6a 5a                	push   $0x5a
  jmp alltraps
80106275:	e9 fd f7 ff ff       	jmp    80105a77 <alltraps>
...
8010627c:	6a 5b                	push   $0x5b
  jmp alltraps
8010627e:	e9 f4 f7 ff ff       	jmp    80105a77 <alltraps>
...
80106285:	6a 5c                	push   $0x5c
  jmp alltraps
80106287:	e9 eb f7 ff ff       	jmp    80105a77 <alltraps>
...
8010628e:	6a 5d                	push   $0x5d
  jmp alltraps
80106290:	e9 e2 f7 ff ff       	jmp    80105a77 <alltraps>
...
80106297:	6a 5e                	push   $0x5e
  jmp alltraps
80106299:	e9 d9 f7 ff ff       	jmp    80105a77 <alltraps>
...
801062a0:	6a 5f                	push   $0x5f
  jmp alltraps
801062a2:	e9 d0 f7 ff ff       	jmp    80105a77 <alltraps>
...
801062a9:	6a 60                	push   $0x60
  jmp alltraps
801062ab:	e9 c7 f7 ff ff       	jmp    80105a77 <alltraps>
...
801062b2:	6a 61                	push   $0x61
  jmp alltraps
801062b4:	e9 be f7 ff ff       	jmp    80105a77 <alltraps>
...
801062bb:	6a 62                	push   $0x62
  jmp alltraps
801062bd:	e9 b5 f7 ff ff       	jmp    80105a77 <alltraps>
...
801062c4:	6a 63                	push   $0x63
  jmp alltraps
801062c6:	e9 ac f7 ff ff       	jmp    80105a77 <alltraps>
...
801062cd:	6a 64                	push   $0x64
  jmp alltraps
801062cf:	e9 a3 f7 ff ff       	jmp    80105a77 <alltraps>
...
801062d6:	6a 65                	push   $0x65
  jmp alltraps
801062d8:	e9 9a f7 ff ff       	jmp    80105a77 <alltraps>
...
801062df:	6a 66                	push   $0x66
  jmp alltraps
801062e1:	e9 91 f7 ff ff       	jmp    80105a77 <alltraps>
...
801062e8:	6a 67                	push   $0x67
  jmp alltraps
801062ea:	e9 88 f7 ff ff       	jmp    80105a77 <alltraps>
...
801062f1:	6a 68                	push   $0x68
  jmp alltraps
801062f3:	e9 7f f7 ff ff       	jmp    80105a77 <alltraps>
...
801062fa:	6a 69                	push   $0x69
  jmp alltraps
801062fc:	e9 76 f7 ff ff       	jmp    80105a77 <alltraps>
...
80106303:	6a 6a                	push   $0x6a
  jmp alltraps
80106305:	e9 6d f7 ff ff       	jmp    80105a77 <alltraps>
...
8010630c:	6a 6b                	push   $0x6b
  jmp alltraps
8010630e:	e9 64 f7 ff ff       	jmp    80105a77 <alltraps>
...
80106315:	6a 6c                	push   $0x6c
  jmp alltraps
80106317:	e9 5b f7 ff ff       	jmp    80105a77 <alltraps>
...
8010631e:	6a 6d                	push   $0x6d
  jmp alltraps
80106320:	e9 52 f7 ff ff       	jmp    80105a77 <alltraps>
...
80106327:	6a 6e                	push   $0x6e
  jmp alltraps
80106329:	e9 49 f7 ff ff       	jmp    80105a77 <alltraps>
...
80106330:	6a 6f                	push   $0x6f
  jmp alltraps
80106332:	e9 40 f7 ff ff       	jmp    80105a77 <alltraps>
...
80106339:	6a 70                	push   $0x70
  jmp alltraps
8010633b:	e9 37 f7 ff ff       	jmp    80105a77 <alltraps>
...
80106342:	6a 71                	push   $0x71
  jmp alltraps
80106344:	e9 2e f7 ff ff       	jmp    80105a77 <alltraps>
...
8010634b:	6a 72                	push   $0x72
  jmp alltraps
8010634d:	e9 25 f7 ff ff       	jmp    80105a77 <alltraps>
...
80106354:	6a 73                	push   $0x73
  jmp alltraps
80106356:	e9 1c f7 ff ff       	jmp    80105a77 <alltraps>
...
8010635d:	6a 74                	push   $0x74
  jmp alltraps
8010635f:	e9 13 f7 ff ff       	jmp    80105a77 <alltraps>
...
80106366:	6a 75                	push   $0x75
  jmp alltraps
80106368:	e9 0a f7 ff ff       	jmp    80105a77 <alltraps>
...
8010636f:	6a 76                	push   $0x76
  jmp alltraps
80106371:	e9 01 f7 ff ff       	jmp    80105a77 <alltraps>
...
80106378:	6a 77                	push   $0x77
  jmp alltraps
8010637a:	e9 f8 f6 ff ff       	jmp    80105a77 <alltraps>
...
80106381:	6a 78                	push   $0x78
  jmp alltraps
80106383:	e9 ef f6 ff ff       	jmp    80105a77 <alltraps>
...
8010638a:	6a 79                	push   $0x79
  jmp alltraps
8010638c:	e9 e6 f6 ff ff       	jmp    80105a77 <alltraps>
...
80106393:	6a 7a                	push   $0x7a
  jmp alltraps
80106395:	e9 dd f6 ff ff       	jmp    80105a77 <alltraps>
...
8010639c:	6a 7b                	push   $0x7b
  jmp alltraps
8010639e:	e9 d4 f6 ff ff       	jmp    80105a77 <alltraps>
...
801063a5:	6a 7c                	push   $0x7c
  jmp alltraps
801063a7:	e9 cb f6 ff ff       	jmp    80105a77 <alltraps>
...
801063ae:	6a 7d                	push   $0x7d
  jmp alltraps
801063b0:	e9 c2 f6 ff ff       	jmp    80105a77 <alltraps>
...
801063b7:	6a 7e                	push   $0x7e
  jmp alltraps
801063b9:	e9 b9 f6 ff ff       	jmp    80105a77 <alltraps>
...
801063c0:	6a 7f                	push   $0x7f
  jmp alltraps
801063c2:	e9 b0 f6 ff ff       	jmp    80105a77 <alltraps>
...
801063c9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801063ce:	e9 a4 f6 ff ff       	jmp    80105a77 <alltraps>
...
801063d5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801063da:	e9 98 f6 ff ff       	jmp    80105a77 <alltraps>
...
801063e1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801063e6:	e9 8c f6 ff ff       	jmp    80105a77 <alltraps>
...
801063ed:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801063f2:	e9 80 f6 ff ff       	jmp    80105a77 <alltraps>
...
801063f9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801063fe:	e9 74 f6 ff ff       	jmp    80105a77 <alltraps>
...
80106405:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010640a:	e9 68 f6 ff ff       	jmp    80105a77 <alltraps>
...
80106411:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106416:	e9 5c f6 ff ff       	jmp    80105a77 <alltraps>
...
8010641d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106422:	e9 50 f6 ff ff       	jmp    80105a77 <alltraps>
...
80106429:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010642e:	e9 44 f6 ff ff       	jmp    80105a77 <alltraps>
...
80106435:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010643a:	e9 38 f6 ff ff       	jmp    80105a77 <alltraps>
...
80106441:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106446:	e9 2c f6 ff ff       	jmp    80105a77 <alltraps>
...
8010644d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106452:	e9 20 f6 ff ff       	jmp    80105a77 <alltraps>
...
80106459:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010645e:	e9 14 f6 ff ff       	jmp    80105a77 <alltraps>
...
80106465:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010646a:	e9 08 f6 ff ff       	jmp    80105a77 <alltraps>
...
80106471:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106476:	e9 fc f5 ff ff       	jmp    80105a77 <alltraps>
...
8010647d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106482:	e9 f0 f5 ff ff       	jmp    80105a77 <alltraps>
...
80106489:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010648e:	e9 e4 f5 ff ff       	jmp    80105a77 <alltraps>
...
80106495:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010649a:	e9 d8 f5 ff ff       	jmp    80105a77 <alltraps>
...
801064a1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801064a6:	e9 cc f5 ff ff       	jmp    80105a77 <alltraps>
...
801064ad:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801064b2:	e9 c0 f5 ff ff       	jmp    80105a77 <alltraps>
...
801064b9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801064be:	e9 b4 f5 ff ff       	jmp    80105a77 <alltraps>
...
801064c5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801064ca:	e9 a8 f5 ff ff       	jmp    80105a77 <alltraps>
...
801064d1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801064d6:	e9 9c f5 ff ff       	jmp    80105a77 <alltraps>
...
801064dd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801064e2:	e9 90 f5 ff ff       	jmp    80105a77 <alltraps>
...
801064e9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801064ee:	e9 84 f5 ff ff       	jmp    80105a77 <alltraps>
...
801064f5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801064fa:	e9 78 f5 ff ff       	jmp    80105a77 <alltraps>
...
80106501:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106506:	e9 6c f5 ff ff       	jmp    80105a77 <alltraps>
...
8010650d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106512:	e9 60 f5 ff ff       	jmp    80105a77 <alltraps>
...
80106519:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010651e:	e9 54 f5 ff ff       	jmp    80105a77 <alltraps>
...
80106525:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010652a:	e9 48 f5 ff ff       	jmp    80105a77 <alltraps>
...
80106531:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106536:	e9 3c f5 ff ff       	jmp    80105a77 <alltraps>
...
8010653d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106542:	e9 30 f5 ff ff       	jmp    80105a77 <alltraps>
...
80106549:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010654e:	e9 24 f5 ff ff       	jmp    80105a77 <alltraps>
...
80106555:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010655a:	e9 18 f5 ff ff       	jmp    80105a77 <alltraps>
...
80106561:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106566:	e9 0c f5 ff ff       	jmp    80105a77 <alltraps>
...
8010656d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106572:	e9 00 f5 ff ff       	jmp    80105a77 <alltraps>
...
80106579:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010657e:	e9 f4 f4 ff ff       	jmp    80105a77 <alltraps>
...
80106585:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010658a:	e9 e8 f4 ff ff       	jmp    80105a77 <alltraps>
...
80106591:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106596:	e9 dc f4 ff ff       	jmp    80105a77 <alltraps>
...
8010659d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801065a2:	e9 d0 f4 ff ff       	jmp    80105a77 <alltraps>
...
801065a9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801065ae:	e9 c4 f4 ff ff       	jmp    80105a77 <alltraps>
...
801065b5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801065ba:	e9 b8 f4 ff ff       	jmp    80105a77 <alltraps>
...
801065c1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801065c6:	e9 ac f4 ff ff       	jmp    80105a77 <alltraps>
...
801065cd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801065d2:	e9 a0 f4 ff ff       	jmp    80105a77 <alltraps>
...
801065d9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801065de:	e9 94 f4 ff ff       	jmp    80105a77 <alltraps>
...
801065e5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801065ea:	e9 88 f4 ff ff       	jmp    80105a77 <alltraps>
...
801065f1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801065f6:	e9 7c f4 ff ff       	jmp    80105a77 <alltraps>
...
801065fd:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106602:	e9 70 f4 ff ff       	jmp    80105a77 <alltraps>
...
80106609:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010660e:	e9 64 f4 ff ff       	jmp    80105a77 <alltraps>
...
80106615:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010661a:	e9 58 f4 ff ff       	jmp    80105a77 <alltraps>
...
80106621:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106626:	e9 4c f4 ff ff       	jmp    80105a77 <alltraps>
...
8010662d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106632:	e9 40 f4 ff ff       	jmp    80105a77 <alltraps>
...
80106639:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010663e:	e9 34 f4 ff ff       	jmp    80105a77 <alltraps>
...
80106645:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010664a:	e9 28 f4 ff ff       	jmp    80105a77 <alltraps>
...
80106651:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106656:	e9 1c f4 ff ff       	jmp    80105a77 <alltraps>
...
8010665d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106662:	e9 10 f4 ff ff       	jmp    80105a77 <alltraps>
...
80106669:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010666e:	e9 04 f4 ff ff       	jmp    80105a77 <alltraps>
...
80106675:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010667a:	e9 f8 f3 ff ff       	jmp    80105a77 <alltraps>
...
80106681:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106686:	e9 ec f3 ff ff       	jmp    80105a77 <alltraps>
...
8010668d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106692:	e9 e0 f3 ff ff       	jmp    80105a77 <alltraps>
...
80106699:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010669e:	e9 d4 f3 ff ff       	jmp    80105a77 <alltraps>
...
801066a5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801066aa:	e9 c8 f3 ff ff       	jmp    80105a77 <alltraps>
...
801066b1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801066b6:	e9 bc f3 ff ff       	jmp    80105a77 <alltraps>
...
801066bd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801066c2:	e9 b0 f3 ff ff       	jmp    80105a77 <alltraps>
...
801066c9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801066ce:	e9 a4 f3 ff ff       	jmp    80105a77 <alltraps>
...
801066d5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801066da:	e9 98 f3 ff ff       	jmp    80105a77 <alltraps>
...
801066e1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801066e6:	e9 8c f3 ff ff       	jmp    80105a77 <alltraps>
...
801066ed:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801066f2:	e9 80 f3 ff ff       	jmp    80105a77 <alltraps>
...
801066f9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801066fe:	e9 74 f3 ff ff       	jmp    80105a77 <alltraps>
...
80106705:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010670a:	e9 68 f3 ff ff       	jmp    80105a77 <alltraps>
...
80106711:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106716:	e9 5c f3 ff ff       	jmp    80105a77 <alltraps>
...
8010671d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106722:	e9 50 f3 ff ff       	jmp    80105a77 <alltraps>
...
80106729:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010672e:	e9 44 f3 ff ff       	jmp    80105a77 <alltraps>
...
80106735:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010673a:	e9 38 f3 ff ff       	jmp    80105a77 <alltraps>
...
80106741:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106746:	e9 2c f3 ff ff       	jmp    80105a77 <alltraps>
...
8010674d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106752:	e9 20 f3 ff ff       	jmp    80105a77 <alltraps>
...
80106759:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010675e:	e9 14 f3 ff ff       	jmp    80105a77 <alltraps>
...
80106765:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010676a:	e9 08 f3 ff ff       	jmp    80105a77 <alltraps>
...
80106771:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106776:	e9 fc f2 ff ff       	jmp    80105a77 <alltraps>
...
8010677d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106782:	e9 f0 f2 ff ff       	jmp    80105a77 <alltraps>
...
80106789:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010678e:	e9 e4 f2 ff ff       	jmp    80105a77 <alltraps>
...
80106795:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010679a:	e9 d8 f2 ff ff       	jmp    80105a77 <alltraps>
...
801067a1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801067a6:	e9 cc f2 ff ff       	jmp    80105a77 <alltraps>
...
801067ad:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801067b2:	e9 c0 f2 ff ff       	jmp    80105a77 <alltraps>
...
801067b9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801067be:	e9 b4 f2 ff ff       	jmp    80105a77 <alltraps>
...
801067c5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801067ca:	e9 a8 f2 ff ff       	jmp    80105a77 <alltraps>
...
801067d1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801067d6:	e9 9c f2 ff ff       	jmp    80105a77 <alltraps>
...
801067dd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801067e2:	e9 90 f2 ff ff       	jmp    80105a77 <alltraps>
...
801067e9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801067ee:	e9 84 f2 ff ff       	jmp    80105a77 <alltraps>
...
801067f5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801067fa:	e9 78 f2 ff ff       	jmp    80105a77 <alltraps>
...
80106801:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106806:	e9 6c f2 ff ff       	jmp    80105a77 <alltraps>
...
8010680d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106812:	e9 60 f2 ff ff       	jmp    80105a77 <alltraps>
...
80106819:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010681e:	e9 54 f2 ff ff       	jmp    80105a77 <alltraps>
...
80106825:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010682a:	e9 48 f2 ff ff       	jmp    80105a77 <alltraps>
...
80106831:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106836:	e9 3c f2 ff ff       	jmp    80105a77 <alltraps>
...
8010683d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106842:	e9 30 f2 ff ff       	jmp    80105a77 <alltraps>
...
80106849:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010684e:	e9 24 f2 ff ff       	jmp    80105a77 <alltraps>
...
80106855:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010685a:	e9 18 f2 ff ff       	jmp    80105a77 <alltraps>
...
80106861:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106866:	e9 0c f2 ff ff       	jmp    80105a77 <alltraps>
...
8010686d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106872:	e9 00 f2 ff ff       	jmp    80105a77 <alltraps>
...
80106879:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010687e:	e9 f4 f1 ff ff       	jmp    80105a77 <alltraps>
...
80106885:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010688a:	e9 e8 f1 ff ff       	jmp    80105a77 <alltraps>
...
80106891:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106896:	e9 dc f1 ff ff       	jmp    80105a77 <alltraps>
...
8010689d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801068a2:	e9 d0 f1 ff ff       	jmp    80105a77 <alltraps>
...
801068a9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801068ae:	e9 c4 f1 ff ff       	jmp    80105a77 <alltraps>
...
801068b5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801068ba:	e9 b8 f1 ff ff       	jmp    80105a77 <alltraps>
...
801068c1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801068c6:	e9 ac f1 ff ff       	jmp    80105a77 <alltraps>
...
801068cd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801068d2:	e9 a0 f1 ff ff       	jmp    80105a77 <alltraps>
...
801068d9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801068de:	e9 94 f1 ff ff       	jmp    80105a77 <alltraps>
...
801068e5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801068ea:	e9 88 f1 ff ff       	jmp    80105a77 <alltraps>
...
801068f1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801068f6:	e9 7c f1 ff ff       	jmp    80105a77 <alltraps>
...
801068fd:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106902:	e9 70 f1 ff ff       	jmp    80105a77 <alltraps>
...
80106909:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010690e:	e9 64 f1 ff ff       	jmp    80105a77 <alltraps>
...
80106915:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010691a:	e9 58 f1 ff ff       	jmp    80105a77 <alltraps>
...
80106921:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106926:	e9 4c f1 ff ff       	jmp    80105a77 <alltraps>
...
8010692d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106932:	e9 40 f1 ff ff       	jmp    80105a77 <alltraps>
...
80106939:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010693e:	e9 34 f1 ff ff       	jmp    80105a77 <alltraps>
...
80106945:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010694a:	e9 28 f1 ff ff       	jmp    80105a77 <alltraps>
...
80106951:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106956:	e9 1c f1 ff ff       	jmp    80105a77 <alltraps>
...
8010695d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106962:	e9 10 f1 ff ff       	jmp    80105a77 <alltraps>
...
80106969:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010696e:	e9 04 f1 ff ff       	jmp    80105a77 <alltraps>
...
80106975:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010697a:	e9 f8 f0 ff ff       	jmp    80105a77 <alltraps>
...
80106981:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106986:	e9 ec f0 ff ff       	jmp    80105a77 <alltraps>
...
8010698d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106992:	e9 e0 f0 ff ff       	jmp    80105a77 <alltraps>
...
80106999:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010699e:	e9 d4 f0 ff ff       	jmp    80105a77 <alltraps>
...
801069a5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801069aa:	e9 c8 f0 ff ff       	jmp    80105a77 <alltraps>
...
801069b1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801069b6:	e9 bc f0 ff ff       	jmp    80105a77 <alltraps>
...
801069bd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801069c2:	e9 b0 f0 ff ff       	jmp    80105a77 <alltraps>
...
80106a14:	e8 67 ba ff ff       	call   80102480 <kalloc>
...
80106a2a:	e8 41 dd ff ff       	call   80104770 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106acd:	68 8c 7c 10 80       	push   $0x80107c8c
...
80106b24:	e8 a7 b7 ff ff       	call   801022d0 <kfree>
      *pte = 0;
...
80106b72:	68 c6 75 10 80       	push   $0x801075c6
...
80106b83:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
80106b86:	e8 d5 cb ff ff       	call   80103760 <cpuid>
...
80106c80:	a1 a4 6e 11 80       	mov    0x80116ea4,%eax
...
80106cc4:	0f 84 c4 00 00 00    	je     80106d8e <switchuvm+0xee>
  ...
  pushcli();
80106cca:	e8 c1 d8 ff ff       	call   80104590 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106ccf:	e8 0c ca ff ff       	call   801036e0 <mycpu>
80106cd4:	89 c3                	mov    %eax,%ebx
80106cd6:	e8 05 ca ff ff       	call   801036e0 <mycpu>
80106cdb:	89 c7                	mov    %eax,%edi
80106cdd:	e8 fe c9 ff ff       	call   801036e0 <mycpu>
80106ce2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106ce5:	83 c7 08             	add    $0x8,%edi
80106ce8:	e8 f3 c9 ff ff       	call   801036e0 <mycpu>
...
80106d29:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80106d2e:	e8 ad c9 ff ff       	call   801036e0 <mycpu>
80106d33:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106d3a:	e8 a1 c9 ff ff       	call   801036e0 <mycpu>
80106d3f:	b9 10 00 00 00       	mov    $0x10,%ecx
80106d44:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106d48:	e8 93 c9 ff ff       	call   801036e0 <mycpu>
...
80106d56:	89 48 0c             	mov    %ecx,0xc(%eax)
  ...
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106d59:	e8 82 c9 ff ff       	call   801036e0 <mycpu>
...
80106d7b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
80106d7c:	e9 4f d8 ff ff       	jmp    801045d0 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
80106d84:	68 92 7c 10 80       	push   $0x80107c92
...
80106d91:	68 bd 7c 10 80       	push   $0x80107cbd
...
80106d9e:	68 a8 7c 10 80       	push   $0x80107ca8
...
80106dcb:	77 49                	ja     80106e16 <inituvm+0x66>
  ...
  mem = kalloc();
80106dcd:	e8 ae b6 ff ff       	call   80102480 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106ddf:	e8 8c d9 ff ff       	call   80104770 <memset>
...
80106e10:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106e11:	e9 0a da ff ff       	jmp    80104820 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
80106e19:	68 d1 7c 10 80       	push   $0x80107cd1
...
80106ea1:	e8 9a aa ff ff       	call   80101940 <readi>
...
80106ecd:	68 eb 7c 10 80       	push   $0x80107ceb
...
80106eda:	68 8c 7d 10 80       	push   $0x80107d8c
...
80106f33:	e8 38 d8 ff ff       	call   80104770 <memset>
...
80106f61:	76 7d                	jbe    80106fe0 <allocuvm+0xf0>
    mem = kalloc();
80106f63:	e8 18 b5 ff ff       	call   80102480 <kalloc>
    if(mem == 0){
...
80106f71:	68 09 7d 10 80       	push   $0x80107d09
...
80106fa3:	68 21 7d 10 80       	push   $0x80107d21
...
80106fc6:	e8 05 b3 ff ff       	call   801022d0 <kfree>
      return 0;
...
8010706e:	e8 5d b2 ff ff       	call   801022d0 <kfree>
...
80107083:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80107084:	e9 47 b2 ff ff       	jmp    801022d0 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
...
8010708c:	68 3d 7d 10 80       	push   $0x80107d3d
...
801070a5:	e8 d6 b3 ff ff       	call   80102480 <kalloc>
...
801070c0:	e8 ab d6 ff ff       	call   80104770 <memset>
...
8010712b:	a3 a4 6e 11 80       	mov    %eax,0x80116ea4
...
8010715f:	68 4e 7d 10 80       	push   $0x80107d4e
...
80107183:	0f 84 c5 00 00 00    	je     8010724e <copyuvm+0xde>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
801071b0:	e8 6b d6 ff ff       	call   80104820 <memmove>
...
801071d5:	78 69                	js     80107240 <copyuvm+0xd0>
  uint pa, i, flags;
  char *mem;
...
801071f0:	74 6d                	je     8010725f <copyuvm+0xef>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
801071f2:	8b 00                	mov    (%eax),%eax
801071f4:	a8 01                	test   $0x1,%al
801071f6:	74 5a                	je     80107252 <copyuvm+0xe2>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
...
80107205:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80107208:	e8 73 b2 ff ff       	call   80102480 <kalloc>
...
80107244:	e8 87 b0 ff ff       	call   801022d0 <kfree>
      goto bad;
80107249:	83 c4 10             	add    $0x10,%esp
8010724c:	eb c5                	jmp    80107213 <copyuvm+0xa3>
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
...
80107250:	eb d1                	jmp    80107223 <copyuvm+0xb3>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
...
80107255:	68 72 7d 10 80       	push   $0x80107d72
8010725a:	e8 11 91 ff ff       	call   80100370 <panic>
...
80107262:	68 58 7d 10 80       	push   $0x80107d58
80107267:	e8 04 91 ff ff       	call   80100370 <panic>
...
8010728f:	25 00 f0 ff ff       	and    $0xfffff000,%eax
}
80107294:	c9                   	leave  
  pte = walkpgdir(pgdir, uva, 0);
  if((*pte & PTE_P) == 0)
...
801072ef:	e8 2c d5 ff ff       	call   80104820 <memmove>
    len -= n;
    buf += n;
