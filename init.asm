...
main(void)
{
  ...
  98:	53                   	push   %ebx
  99:	53                   	push   %ebx
  9a:	68 eb 07 00 00       	push   $0x7eb
  9f:	6a 01                	push   $0x1
  a1:	e8 0a 04 00 00       	call   4b0 <printf>
      exit(FAIL_STATUS);
  ...
  b2:	50                   	push   %eax
  b3:	50                   	push   %eax
  b4:	68 c8 0a 00 00       	push   $0xac8
  b9:	68 fe 07 00 00       	push   $0x7fe
  be:	e8 c7 02 00 00       	call   38a <exec>
      printf(1, "init: exec sh failed\n");
  c3:	5a                   	pop    %edx
  c4:	59                   	pop    %ecx
  c5:	68 01 08 00 00       	push   $0x801
  ca:	6a 01                	push   $0x1
  cc:	e8 df 03 00 00       	call   4b0 <printf>
      exit(FAIL_STATUS);
  ...
  d8:	e8 75 02 00 00       	call   352 <exit>
{
  ...
  de:	6a 01                	push   $0x1
  e0:	6a 01                	push   $0x1
  e2:	68 d0 07 00 00       	push   $0x7d0
  e7:	e8 ae 02 00 00       	call   39a <mknod>
    open("console", O_RDWR);
  ec:	58                   	pop    %eax
  ed:	5a                   	pop    %edx
  ee:	6a 02                	push   $0x2
  f0:	68 d0 07 00 00       	push   $0x7d0
...
free(void *ap)
{
 ...
 6a7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6a9:	a3 d0 0a 00 00       	mov    %eax,0xad0
}
 6ae:	5b                   	pop    %ebx
 6af:	5e                   	pop    %esi
 6b0:	5f                   	pop    %edi
 ...
 6ca:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6cd:	a3 d0 0a 00 00       	mov    %eax,0xad0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 766:	e8 e5 fe ff ff       	call   650 <free>
  return freep;
 76b:	8b 15 d0 0a 00 00    	mov    0xad0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 78c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 78f:	89 15 d0 0a 00 00    	mov    %edx,0xad0
      return (void*)(p + 1);
 ...
 7a4:	eb e9                	jmp    78f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7a6:	c7 05 d0 0a 00 00 d4 	movl   $0xad4,0xad0
 7ad:	0a 00 00 
 7b0:	c7 05 d4 0a 00 00 d4 	movl   $0xad4,0xad4
 7b7:	0a 00 00 
    base.s.size = 0;
 7ba:	b8 d4 0a 00 00       	mov    $0xad4,%eax
 7bf:	c7 05 d8 0a 00 00 00 	movl   $0x0,0xad8
 7c6:	00 00 00 
